package com.csii.bop.pcommon.signature.keymanager;
...
public class DataCertCreate {
    ...
    private String KEYSTORE_PASSWORD = "206302";
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeyException,
        ...
        String[] info = {"JKGF", "hnu", "university", "china", "beijing", "miyun", "111111", "11111111", "1"};
        // 生成公钥
    ...
    public X509Certificate generateCert(String[] info, KeyPair keyPair_root, KeyPair keyPair_user)
        ...
        certGen.setIssuerDN(new X509Name("CN=JKGF, OU=hnu, O=university , C=china"));
...
//        certGen.setSignatureAlgorithm("SHA1WithRSA");
    ...
    public Boolean toPFX(String[] info) {
        try {
            String pfx_keystore_file = "D:/priKey" + info[0] + ".pfx";
    ...
    public boolean createPublicKey(String[] info) {
        try {
            ...
            String certPath = path + "pubKey" + info[0] + ".cer";
