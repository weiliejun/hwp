...
public interface UserInfoService {
    ...
    UserInfo getUserInfoByIDNO(String userName, String mobile, String idNo);

    UserInfo getUserInfoByUserNameAndPassword(Map<String, Object> params);
     ...
     * @Description 修改登陆密码
     * @auther: xsp
     * @UpadteDate: 2019/3/13 17:49
     */
    Map<String, Object> updatePassword(Integer userId, String newPassword);

    /**
     * @param userId
     * @param newTrsPassword
     * @return
     * @Description 修改交易密码
     * @auther: 李洪斌
     * @UpadteDate: 2019/6/20 17:49
     */
    Map<String, Object> updateTrsPassword(Integer userId, String newTrsPassword);
