package com.hwp.common.redis.service;

import com.hwp.common.redis.dao.CacheDao;
import com.hwp.common.util.CommonUtil;
...
public class CacheServiceImpl implements CacheService {
    ...
    public Set<String> getKeys(String keyPattern) {
        return cacheDao.getKeys(keyPattern);
    }

    @Override
    public boolean hasKey(String key) {
        return cacheDao.hasKey(key);
    }
