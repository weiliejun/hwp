...
public class UserInfoDao extends AbstractBaseDao {
    ...
    /**
     * @Description: 根据用户ID修改信息
     * @Author: lvjian
     * @UpdateDate: 2019/9/3 16:08
     */
    ...
    /**
     * @Description: 根据身份证号，手机号，姓名获取用户信息
     * @Author: lvjain
     * @UpdateDate: 2019/6/18 16:08
     */
    public UserInfo getUserInfoByIDNO(String userName, String mobile, String idNo) {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("userName", userName);
        params.put("mobile", mobile);
        params.put("idNo", idNo);
        return (UserInfo) queryForObject("userinfo.getUserInfoByIDNO", params);
    }

    /**
     * @Description: 根据电子账户获取用户信息
     * @Author: lvjain
     * @UpdateDate: 2019/6/18 16:08
     */
    public UserInfo getUserInfoByAccountNo(String eaccountNo) {
        return (UserInfo) queryForObject("userinfo.getUserInfoByAccountNo", eaccountNo);
    }
     ...
     * @param productId
     * @return
     * @description 查询产品投标成功的用户
     * @version 1.0
     * @author 张可乐
     * @update 2017-3-22 下午4:16:19
     */
    public List<Map> findUsersOfTenderSuccess(String productId) {
        return queryForList("userinfo.findUsersOfTenderSuccess", productId);
    }
}
