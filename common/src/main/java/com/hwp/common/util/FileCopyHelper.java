...
import com.hwp.common.components.exception.IORuntimeException;
...
public class FileCopyHelper {
    ...
    public static final Logger logger = Logger.getLogger(SystemPropertyHelper.class);
    ...
    public static int copy(InputStream in, OutputStream out) throws IOException {
        ...
        try {
            ...
            try {
                ...
                throw new IORuntimeException("Could not close InputStream", ex);
            }
            try {
                out.close();
            } catch (IOException ex) {
                logger.warn("Could not close OutputStream");
                throw new IORuntimeException("Could not close OutputStream", ex);
            }
        }
    }
    ...
    public static int copy(Reader in, Writer out) throws IOException {
        ...
        try {
            ...
            try {
                ...
                logger.warn("Could not close Reader");
                throw new IORuntimeException("Could not close Reader", ex);
            }
            try {
                out.close();
            } catch (IOException ex) {
                logger.warn("Could not close Writer");
                throw new IORuntimeException("Could not close Writer", ex);
            }
        }
    }
