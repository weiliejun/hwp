...
(function () {
        ...
        -1;) {
            ...
            if (d) {
                ...
                for (h = 0; h < i; h++)
                    e = e[g[h]];
                if (f.length)
                    f = f.join(":"), g = /\.([0-9])/, h = M.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = D.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = ia(f, e)
            }
            k.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    function Nb() {
        ...
        lb = function (a, c, d, h, i, k) {
            var j;
            b ? (j =
                ea.UTC.apply(0, arguments), j += Za(j)) : j = (new ea(a, c, p(d, 1), p(h, 0), p(i, 0), p(k, 0))).getTime();
            return j
        };
        yb = c + "Minutes";
        zb = c + "Hours";
    ...
    var s,
        ...
        Tb = S.opera,
        Da = /(msie|trident)/i.test(Fa) && !Tb,
        mb = C.documentMode === 8,
        nb = /AppleWebKit/.test(Fa),
        Ta = /Firefox/.test(Fa),
        cb = /(Mobile|Android|Windows Phone)/.test(Fa),
        Ma = "http://www.w3.org/2000/svg",
        da = !!C.createElementNS && !!C.createElementNS(Ma, "svg").createSVGRect,
        Yb = Ta && parseInt(Fa.split("Firefox/")[1], 10) < 4,
        la = !da && !Da && !!C.createElement("canvas").getContext,
        Ua,
        Ya,
        Ub = {},
        Gb = 0,
        ...
        I = {},
        D;
    D = S.Highcharts = S.Highcharts ? pa(16, !0) : {};
    D.seriesTypes = I;
    var v = D.extend = function (a, b) {
            var c;
            a || (a = {});
            for (c in b)
                a[c] =
    ...
    D.numberFormat = function (a, b, c, d) {
        var e = M.lang,
            a = +a || 0,
            f = b ===
            -1 ? B((a.toString().split(".")[1] || "").length, 20) : isNaN(b = P(b)) ? 2 : b,
                ...
                a.each(["cur", "_default", "width", "height", "opacity"], function (b, e) {
                    ...
                    (g = f[e]) && (f[e] = function (a) {
                        var c,
                            a = b ? a : this;
                        if (a.prop !== "align")
                            return c = a.elem, c.attr ? c.attr(a.prop, e === "cur" ? s : a.now) : g.apply(this, arguments)
                    })
                });
                Q(a.cssHooks.opacity,
                    "get", function (a, b, c) {
        ...
        va = function (a) {
            ...
            (function (a) {
                a && a.stops ? d = za(a.stops, function (a) {
                    return va(a[1])
                }) : (c = dc.exec(a)) ? b = [G(c[1]), G(c[2]), G(c[3]), parseFloat(c[4], 10)] : (c = ec.exec(a)) ? b = [G(c[1], 16), G(c[2], 16), G(c[3], 16), 1] : (c = fc.exec(a)) && (b = [G(c[1]), G(c[2]), G(c[3]), 1])
            })(a);
            return {
                get: function (c) {
                    var f;
                    d ? (f = A(a), f.stops = [].concat(f.stops), n(d, function (a, b) {
                        f.stops[b] = [f.stops[b][0], a.get(c)]
                    })) : f = b && !isNaN(b[0]) ? c === "rgb" ? "rgb(" + b[0] + "," + b[1] +
                        "," + b[2] + ")" : c === "a" ? b[3] : "rgba(" + b.join(",") + ")" : a;
                    return f
                },
                brighten: function (a) {
                    if (d)
                        ...
                        var c;
                        for (c = 0; c < 3; c++)
                            b[c] += G(a * 255), b[c] < 0 && (b[c] = 0), b[c] > 255 && (b[c] = 255)
                    }
                    return this
                },
                rgba: b,
    ...
    Y.prototype = {
        ...
        colorGradient: function (a, b, c) {
            ...
            if (f) {
                ...
                f === "radialGradient" && l && !u(g.gradientUnits) &&
                (g = A(g, {
                ...
                for (o in k)
                    q.push(k[o]);
                q = q.join(",");
                h[q] ? a = h[q].attr("id") : (g.id = a = "highcharts-" + Gb++, h[q] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], n(k, function (a) {
                    a[1].indexOf("rgba") === 0 ? (e = va(a[1]), j = e.get("rgb"), m = e.get("a")) : (j = a[1], m = 1);
        ...
        applyTextShadow: function (a) {
            var b = this.element,
                ...
                e = {},
                f = this.renderer.forExport || b.style.textShadow !== s && !Da;
            if (d)
                e.textShadow = a = a.replace(/contrast/g, this.renderer.getContrast(b.style.fill));
            if (nb)
                e.textRendering = "geometricPrecision";
            f ? K(b, e) : (this.fakeTS = !0, this.ySetter = this.xSetter, c = [].slice.call(b.getElementsByTagName("tspan")), n(a.split(/\s?,\s?/g), function (a) {
                var d = b.firstChild,
                    e,
                    f,
                    a = a.split(" ");
                e = a[a.length - 1];
                (f = a[a.length - 2]) && n(c, function (a,
                                                        c) {
                    var g;
        ...
        on: function (a, b) {
            var c = this,
                d = c.element;
            Ya && a === "click" ? (d.ontouchstart = function (a) {
        ...
        align: function (a, b, c) {
            ...
            f = e.alignedObjects;
            if (a) {
                if (this.alignOptions = a, this.alignByTranslate = b, !c || Ha(c))
        ...
        getBBox: function (a) {
            ...
            if (!b) {
                if (f.namespaceURI === Ma || c.forExport) {
                    try {
                        j = this.fakeTS && function (a) {
                            ...
                            Ta && k.textShadow ? (i = k.textShadow, k.textShadow = "") : j && j(Z),
                            b = f.getBBox ? v({}, f.getBBox()) : {
                                width: f.offsetWidth,
                ...
                if (c.isSVG) {
                    a = b.width;
                    d = b.height;
                    if (Da && g && g.fontSize === "11px" && d.toPrecision(3) === "16.9")
                        b.height = d = 14;
                    if (e)
                        b.width = P(d * fa(h)) + P(a * aa(h)), b.height = P(d * aa(h)) + P(a * fa(h))
                }
                m && (c.cache[m] = b)
            }
            return b
        ...
        shadow: function (a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c)
                        V(f, "height", x(V(f, "height") - h, 0)), f.cutHeight = h;
        ...
        titleSetter: function (a) {
            ...
            b || (b = C.createElementNS(Ma, "title"), this.element.appendChild(b));
        ...
        zIndexSetter: function (a, b) {
            ...
            if (e) {
                ...
                for (i = 0; i < d.length && !h; i++)
                    if (e = d[i], f = V(e, "zIndex"), e !== g && (G(f) > a || !u(a) && u(f)))
    ...
    Y.prototype["stroke-widthSetter"] = Y.prototype.strokeSetter = function (a, b, c) {
        ...
        if (this.stroke && this["stroke-width"])
            this.strokeWidth = this["stroke-width"], Y.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0;
    ...
    ma.prototype = {
        ...
        init: function (a, b, c, d, e) {
            ...
            g = d.element;
            a.appendChild(g);
            a.innerHTML.indexOf("xmlns") === -1 && V(g, "xmlns", Ma);
            this.isSVG = !0;
            this.box = g;
            this.boxWrapper = d;
            this.alignedObjects = [];
            this.url = (Ta || nb) && C.getElementsByTagName("base").length ? f.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
            this.createElement("desc").add().element.appendChild(C.createTextNode("Created with Highstock 2.1.8"));
        ...
        buildText: function (a) {
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, k = V(b, "x"), j = a.styles, m = a.textWidth, l = j && j.lineHeight, o = j && j.textShadow,
                     q = j && j.textOverflow === "ellipsis", r = g.length, F = m && !a.added && this.box, E = function (a) {
                    return l ? G(l) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : j && j.fontSize || c.style.fontSize || 12, a).h
                }, t = function (a) {
                    return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
                }; r--;)
                b.removeChild(g[r]);
            !f && !o && !q && e.indexOf(" ") === -1 ? b.appendChild(C.createTextNode(t(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, F && F.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g,
                ...
                n(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        var o = {},
                            r = C.createElementNS(Ma, "tspan"),
                            F;
                        h.test(e) && (F = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), V(r, "style", F));
                        i.test(e) && !d && (V(r, "onclick", 'location.href="' + e.match(i)[1] + '"'),
                            K(r, {
                                cursor: "pointer"
                            }));
                        e = t(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            if (m) {
                                for (var o = e.replace(/([^\^])-/g, "$1- ").split(" "), p = g.length > 1 || f || o.length > 1 && j.whiteSpace !== "nowrap", n, y, s, u = [], w = E(r), x = 1, v = a.rotation, A = e, B = A.length; (p || q) && (o.length || u.length);)
                                    a.rotation = 0, n = a.getBBox(!0), s = n.width, !da && c.forExport && (s = c.measureSpanWidth(r.firstChild.data,
                                        a.styles)), n = s > m, y === void 0 && (y = n), q && y ? (B /= 2, A === "" || !n && B < 0.5 ? o = [] : (n && (y = !0), A = e.substring(0, A.length + (n ? -1 : 1) * ya(B)), o = [A + (m > 3 ? "\u2026" : "")], r.removeChild(r.firstChild))) : !n || o.length === 1 ? (o = u, u = [], o.length && (x++, r = C.createElementNS(Ma, "tspan"), V(r, {
                                        dy: w,
                                        x: k
                                    }), F && V(r, "style", F), b.appendChild(r)), s > m && (m = s)) : (r.removeChild(r.firstChild), u.unshift(o.pop())), o.length && r.appendChild(C.createTextNode(o.join(" ").replace(/- /g, "-")));
        ...
        button: function (a, b, c, d, e, f, g, h, i) {
            ...
            F = h.style;
            delete h.style;
            z(k.element, Da ? "mouseover" : "mouseenter", function () {
                j !== 3 && k.attr(f).css(q)
            });
            z(k.element, Da ? "mouseout" : "mouseleave", function () {
                j !== 3 && (m = [e, f, g][j], l = [o, q, r][j], k.attr(m).css(l))
            });
            k.setState = function (a) {
                (k.state = j = a) ? a === 2 ? k.attr(g).css(r) : a === 3 && k.attr(h).css(F) : k.attr(e).css(o)
            };
        ...
        symbol: function (a, b, c, d, e, f) {
            ...
            if (h)
                ...
                j = function (a, b) {
                    ...
                    k = a.match(i)[1],
                    a = Ub[k] || f && f.width && f.height && [f.width, f.height],
                    g = this.image(k).attr({
                        x: b,
                        y: c
                    }),
        ...
        symbols: {
            ...
            callout: function (a, b, c, d, e) {
                ...
                h && h > c && e > b + g && e < b + d - g ? i.splice(13, 3, "L", a + c, e - 6, a + c + 6, e, a + c, e + 6, a + c, b + d - f) : h && h < 0 && e > b + g && e < b + d - g ? i.splice(33, 3,
                    "L", a, e + 6, a - 6, e, a, e - 6, a, b + f) : e && e > d && h > a + g && h < a + c - g ? i.splice(23, 3, "L", h + 6, b + d, h, b + d + 6, h - 6, b + d, a + f, b + d) : e && e < 0 && h > a + g && h < a + c - g && i.splice(3, 3, "L", h - 6, b, h, b - 6, h + 6, b, c - f, b);
                return i
            }
        },
            ...
            if (!d)
                a.xSetter = function (a, b, c) {
                    ...
                    for (l = 0; l < d.length; l++)
                        e = d[l], e.getAttribute(b) === f && e.setAttribute(b, a);
                    c.setAttribute(b, a)
                };
            return a
        },
        fontMetrics: function (a, b) {
            ...
            b && S.getComputedStyle && (b = b.element || b, a = (c = S.getComputedStyle(b, "")) && c.fontSize);
        ...
        label: function (a, b, c, d, e, f, g, h, i) {
            function k() {
                var a,
                    b;
                a = q.element.style;
                F = (na === void 0 || Ib === void 0 || o.styles.textAlign) && u(q.textStr) && q.getBBox();
                o.width = (na || F.width || 0) + 2 * t + y;
                o.height = (Ib || F.height || 0) + 2 * t;
                D = t + l.fontMetrics(a && a.fontSize, q).b;
                if (z) {
                    if (!r)
                        a = w(-p * t) + B, b = (h ? -D : 0) + B, o.box = r = d ? l.symbol(d, a, b, o.width, o.height, gb) : l.rect(a, b, o.width, o.height, 0, gb[$b]), r.isImg || r.attr("fill",
                            Z), r.add(o);
                    r.isImg || r.attr(v({
                        width: w(o.width),
                        height: w(o.height)
    ...
    v(Y.prototype, {
        ...
        setSpanRotation: function (a,
                                   b, c) {
            var d = {},
                e = Da ? "-ms-transform" : nb ? "-webkit-transform" : Ta ? "MozTransform" : Tb ? "-o-transform" : "";
                    ...
                    if (this.parentGroup = a) {
                        if (b = a.div, !b) {
                            ...
                            n(k.reverse(), function (a) {
                                ...
                                Q(a, "visibilitySetter", function (a, b, c, e) {
                                    a.call(this, b, c, e);
                                    d[c] = b
                                })
                            })
        ...
        L = {
            ...
            fillSetter: function (a, b, c) {
                ...
                if (d === "SPAN")
                    ...
                    c.filled = a !== Z, this.setAttr("fillcolor", this.renderer.color(a, c, b, this))
            },
            opacitySetter: ja,
            rotationSetter: function (a, b, c) {
                c = c.style;
                this[b] = c[b] = a;
                c.left = -w(fa(a * qa) + 1) + "px";
                c.top = w(aa(a * qa)) + "px"
            },
            ...
            D.VMLElement = L = ha(Y,
                L),
            L.prototype.ySetter = L.prototype.widthSetter = L.prototype.heightSetter = L.prototype.xSetter,
            L = {
                Element: L,
                ...
                init: function (a, b, c, d) {
                    var e;
                    this.alignedObjects = [];
                    d = this.createElement(Sa).css(v(this.getStyle(d), {
                        position: "relative"
                    }));
                    e = d.element;
                ...
                color: function (a, b, c, d) {
                    ...
                    if (i) {
                        var j,
                            m,
                            l = a.linearGradient || a.radialGradient,
                            o,
                            q,
                            r,
                            F,
                        ...
                        if (c === "fill")
                            if (i === "gradient")
                                c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, o = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, t = 'angle="' + (90 - X.atan((l - a) / (o - c)) * 180 / ua) + '"', s();
                            else {
                                var k = l.r,
                                    u = k * 2,
                                    x = k * 2,
                                    ...
                                    k = function () {
                                        A && (B =
                                            d.getBBox(), w += (A[0] - B.x) / B.width - 0.5, v += (A[1] - B.y) / B.height - 0.5, u *= A[2] / B.width, x *= A[2] / B.height);
                                        t = 'src="' + M.global.VMLRadialGradientURL + '" size="' + u + "," + x + '" origin="0.5,0.5" position="' + w + "," + v + '" color2="' + p + '" ';
                                        s()
                                    };
                                d.added ? k() : d.onAdd = k;
                                k = F
                        ...
                        f = va(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], $(this.prepVML(h), null, null, b), k = f.get("rgb");
                    else {
                ...
                g: function (a) {
                    ...
                    return this.createElement(Sa).attr(b)
                },
                image: function (a, b, c, d, e) {
                ...
                symbols: {
                    ...
                    rect: function (a, b, c, d, e) {
                        return ma.prototype.symbols[!u(e) || !e.r ? "square" : "callout"].call(0, a, b, c, d, e)
                    }
                }
            },
            D.VMLRenderer = hb = function () {
                this.init.apply(this, arguments)
            },
            hb.prototype = A(ma.prototype, L),
            Ua = hb;
    ...
    Xa.prototype = {
        addLabel: function () {
            ...
            u(d) ? d && d.attr({
                text: b
            }) : (this.labelLength = (this.label = d = u(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(A(g.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0)
        },
        ...
        handleOverflow: function (a) {
            var b = this.axis,
                ...
                e = b.chart.spacing,
                f = p(b.labelLeft, B(b.pos, e[3])),
                e = p(b.labelRight, x(b.pos +
                    b.len, d - e[1])),
                g = this.label,
                h = this.rotation,
                i = {
                ...
                o = {};
            if (h)
                h < 0 && c - i * k < f ? l = w(c / aa(h * qa) - f) : h > 0 && c + i * k > e && (l = w((d - c) / aa(h * qa)));
            else if (d = c + (1 - i) * k, c - i * k < f ? j = a.x + j * (1 - i) - f : d > e && (j = e - a.x + j * i, m = -1), j = B(b.slotWidth, j), j < b.slotWidth && b.labelAlign === "center" && (a.x += m * (b.slotWidth - j - i * (b.slotWidth - B(k, j)))), k > j || b.autoRotation && g.styles.width)
                l = j;
            if (l) {
                o.width = l;
        ...
        render: function (a, b, c) {
            var d = this.axis,
                ...
                u = !0,
                x = d.tickmarkOffset,
                w = this.getPosition(g, k, x, b),
                v = w.x,
                w = w.y,
                B = g && v === d.pos + d.len || !g && w === d.pos ? -1 : 1,
                c = p(c, 1);
            this.isActive = !0;
            if (q) {
                k = d.getPlotLinePath(k + x, q * B, b, !0);
                if (m === s) {
                    m = {
                        stroke: r,
                        "stroke-width": q
            ...
            if (l && n)
                y === "inside" && (n = -n), d.opposite && (n = -n), h = this.getMarkPath(v,
                    w, n, l * B, g, f), o ? o.animate({
                    d: h,
                    opacity: c
            ...
            if (i && !isNaN(v))
                i.xy = w = this.getLabelPosition(v, w, i, g, j, x, a, na), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? u = !1 : g && !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && this.handleOverflow(w), na && a % na && (u = !1), u && !isNaN(w.y) ? (w.opacity = c, i[this.isNew ? "attr" : "animate"](w), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function () {
            La(this,
                this.axis)
    ...
    D.PlotLineOrBand.prototype = {
        render: function () {
            var a = this,
                ...
                t = {},
                n = b.chart.renderer;
            b.isLog && (i = Ja(i), h = Ja(h), j = Ja(j));
            if (g) {
                if (o = b.getPlotLinePath(j, g), t = {
                    stroke: r,
                    "stroke-width": g
                }, m)
                    t.dashstyle = m
                ...
                if (r)
                    t.fill =
                        r;
                if (d.borderWidth)
                    t.stroke = d.borderColor, t["stroke-width"] = d.borderWidth
            } else
                return;
            if (u(F))
                t.zIndex = F;
            if (l)
            ...
            else if (o && o.length && (a.svgElem = l = n.path(o).attr(t).add(), p))
                for (q in d = function (b) {
                    ...
                    d(q);
            if (e && u(e.text) && o && o.length && b.width > 0 && b.height > 0) {
                e = A({
                    align: c && k && "center",
                    x: c ? !k && 4 : 10,
                ...
                if (!f) {
                    ...
                    if (u(F))
                        t.zIndex = F;
                    a.label = f = n.text(e.text, 0, 0, e.useHTML).attr(t).css(e.style).add()
                }
                b = [o[1], o[4], k ? o[6] : o[1]];
                k = [o[2], o[5], k ? o[7] : o[2]];
                o = Qa(b);
    ...
    J.prototype = {
        ...
        defaultYAxisOptions: {
            ...
            stackLabels: {
                ...
                style: A(U.line.dataLabels.style, {
                    color: "#000000"
                })
            }
        },
        ...
        init: function (a, b) {
            ...
            Na(this, a.axes) === -1 && (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
            ...
            for (f in d)
                z(this, f, d[f]);
            if (this.isLog)
                this.val2lin = Ja, this.lin2val = sa
        },
        setOptions: function (a) {
            this.options =
                A(this.defaultOptions, this.isXAxis ? {}

                    : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], A(M[this.coll], a))
        },
        defaultLabelFormatter: function () {
            ...
            if (h)
                ...
                for (; f-- && g === s;)
                    c = Math.pow(1E3,
                        f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && (g = D.numberFormat(b / c, -1) + e[f]);
            g === s && (g = P(b) >= 1E4 ? D.numberFormat(b, -1) : D.numberFormat(b, -1, s, ""));
            return g
        },
            ...
            n(a.series, function (c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        c = c.dataMin;
                        if (u(c) && u(e))
                            a.dataMin = B(p(a.dataMin, c), c), a.dataMax = x(p(a.dataMax, e), e);
                        if (u(d))
                            if (a.dataMin >= d)
        ...
        translate: function (a, b, c, d, e, f) {
            ...
            b ? (a = a * h + i, a -= j, a = a / k + d, e && (a = g.lin2val(a))) : (e && (a = g.val2lin(a)), f === "between" && (f = 0.5), a = h * (a - d) * k + i + h * j + (ra(f) ? k * f * g.pointRange : 0));
            return a
        },
        ...
        getPlotLinePath: function (a, b, c, d, e) {
            ...
            var o = function (a, b, c) {
                ...
                a = c = w(e + i);
            i = k = w(j - e - i);
            isNaN(e) ? l = !0 : this.horiz ? (i = h, k = j - this.bottom, a = c = o(a, g, g + this.width)) : (a = g, c = m - this.right, i = k = o(i, h, h + this.height));
        ...
        setAxisTranslation: function (a) {
            ...
            if (j || i || d)
                if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : n(b.series, function (a) {
                    var h = i ? 1 : j ? a.pointRange : b.axisPointRange || 0,
                        k = a.options.pointPlacement,
                        q = a.closestPointRange;
                    h > c && (h = 0);
                    d = x(d, h);
                    b.single || (f = x(f, Ha(k) ? 0 : h / 2), g = x(g,
                        k === "on" ? 0 : h));
                    !a.noSharedTooltip && u(q) && (e = u(e) ? B(e, q) : q)
                }), h = b.ordinalSlope && e ? b.ordinalSlope / e : 1, b.minPointOffset = f *= h, b.pointRangePadding = g *= h, b.pointRange = B(d, c), j)
        ...
        setTickInterval: function (a) {
            ...
            if (e)
                !a && B(b.min, p(b.dataMin, b.min)) <= 0 && pa(10, 1), b.min = ka(Ja(b.min), 15), b.max = ka(Ja(b.max), 15);
            if (b.range && u(b.max))
                b.userMin = b.min = x(b.min, b.minFromRange()), b.userMax = b.max,
                    b.range = null;
            b.beforePadding && b.beforePadding();
            b.adjustForMinRange();
            if (!l && !b.axisPointRange && !b.usePercentage && !h && u(b.min) && u(b.max) && (c = b.max - b.min)) {
                if (!u(d.min) && !u(b.userMin) && k && (b.dataMin < 0 || !b.ignoreMinPadding))
                    b.min -= c * k;
                if (!u(d.max) && !u(b.userMax) && i && (b.dataMax > 0 || !b.ignoreMaxPadding))
                    b.max += c * i
            }
            if (ra(d.floor))
                b.min = x(b.min, d.floor);
            if (ra(d.ceiling))
                b.max = B(b.max, d.ceiling);
            b.tickInterval = b.min === b.max || b.min === void 0 || b.max === void 0 ? 1 : h && !j && m === b.linkedParent.options.tickPixelInterval ?
                j = b.linkedParent.tickInterval : p(j, this.tickAmount ? (b.max - b.min) / x(this.tickAmount - 1, 1) : void 0, l ? 1 : (b.max - b.min) * m / x(b.len, m));
            ...
            if (b.pointRange)
                b.tickInterval = x(b.pointRange, b.tickInterval);
            a = p(d.minTickInterval, b.isDatetimeAxis && b.closestPointRange);
            if (!j &&
                b.tickInterval < a)
                b.tickInterval = a;
            if (!f && !e && !j)
                b.tickInterval = wb(b.tickInterval, null, vb(b.tickInterval), p(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1E3 && b.max < 9999)), !!this.tickAmount);
        ...
        setTickPositions: function () {
            ...
            if (!b && (b = this.isDatetimeAxis ? this.getTimeTicks(this.normalizeTimeTickInterval(this.tickInterval, a.units), this.min, this.max, a.startOfWeek, this.ordinalPositions, this.closestPointRange, !0) : this.isLog ? this.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max), b.length > this.len && (b = [b[0], b.pop()]),
                this.tickPositions = b, d && (d = d.apply(this, [this.min, this.max]))))
                this.tickPositions = b = d;
            if (!this.isLinked)
                this.trimTicks(b, e, f), this.min === this.max && u(this.min) && !this.tickAmount && (g = !0, this.min -= 0.5, this.max += 0.5), this.single = g, !c && !d && this.adjustTickAmount()
        },
        ...
        unsquish: function () {
            ...
            c ? (m = u(h) ? [h] : f < p(b.autoRotationLimit, 80) && !b.staggerLines && !b.step && b.autoRotation) && n(m, function (a) {
                var b;
                if (a === h || a && a >= -90 && a <= 90)
                    k = l(P(i.h / fa(qa * a))), b = k + P(a / 360), b < j && (j = b, g = a, e = k)
            }) : b.step || (e = l(i.h));
            this.autoRotation = m;
        ...
        renderUnsquish: function () {
                ...
                for (i = c.length; !f && i--;)
                    if (k = c[i], k = d[k].label)
                        if (k.styles.textOverflow === "ellipsis" && k.css({
                            textOverflow: "clip"
                        }), k.getBBox().height > this.len / c.length - (g.h - g.f))
                            k.specCss = {
            ...
            n(c, function (a) {
                var b = (a = d[a]) && a.label;
                if (b)
                    m && b.css(A(m, b.specCss)), delete b.specCss, b.attr(j), a.rotation =
                        j.rotation
            });
        ...
        getOffset: function () {
            ...
            if (k || a.isLinked) {
                if (n(e, function (b) {
                    ...
                    if (h === 0 || h === 2 || {
                        ...
                        [h] === a.labelAlign)
                        F = x(f[b].getLabelSize(), F)
                }), a.staggerLines)
                    F *= a.staggerLines, a.labelOffset = F
            } else
                for (y in f)
                    f[y].destroy(),
                        delete f[y];
            if (q && q.text && q.enabled !== !1) {
                ...
                if (j)
                    m = a.axisTitle.getBBox()[g ? "height" : "width"], l = q.offset, o = u(l) ? 0 : p(q.margin, g ? 5 : 10);
                a.axisTitle[j ? "show" : "hide"]()
            }
            a.offset = t * p(d.offset, E[h]);
            a.tickRotCorr = a.tickRotCorr || {
                x: 0,
                y: 0
            };
            c = h === 2 ? a.tickRotCorr.y : 0;
            g = F + o + (F && t * (g ? p(r.y, a.tickRotCorr.y + 8) : r.x) - c);
            a.axisTitleMargin = p(l, g);
            E[h] = x(E[h], a.axisTitleMargin + m + t * a.offset, g);
            d = d.offset ? 0 : W(d.lineWidth / 2) * 2;
            b[i] = x(b[i], d)
        },
        ...
        render: function () {
            var a = this,
                ...
                q = d.lineWidth,
                r,
                F = b.hasRendered && u(a.oldMin) && !isNaN(a.oldMin),
                p = a.showAxis,
                t = c.globalAnimation,
                y,
                w;
            ...
            if (a.hasData() || f) {
                ...
                if (g.length && (n(g, function (b, c) {
                    if (!f || b >= a.min &&
                        b <= a.max)
                        i[b] || (i[b] = new Xa(a, b)) , F && i[b].isNew && i[b].render(c, !0, 0.1), i[b].render(c)
                }), o && (a.min === 0 || a.single))) i[-1] || (i[-1] = new Xa(a, -1, null, !0)), i[-1].render(-1);
                l && n(g, function (b, c) {
                    if (c % 2 === 0 && b < a.max)
                        j[b] || (j[b] = new D.PlotLineOrBand(a)), y = b + o, w = g[c + 1] !== s ? g[c + 1] + o : a.max, j[b].options = {
                            from: e ? sa(y) : y,
                            to: e ? sa(w) : w,
                            color: l
                        },
            ...
            if (h && p)
                h[h.isNew ? "attr" : "animate"](a.getTitlePosition()), h.isNew =
                    !1;
        ...
        drawCrosshair: function (a, b) {
            var c,
                d = this.crosshair,
                e = d.animation;
            if (!this.crosshair || (u(b) || !p(this.crosshair.snap, !0)) === !1 || b && b.series && b.series[this.coll] !== this)
                this.hideCrosshair();
            else if (p(d.snap, !0) ? u(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null)
                this.hideCrosshair();
            else if (this.cross)
                this.cross.attr({
                    visibility: "visible"
    ...
    J.prototype.getTimeTicks = function (a, b, c, d) {
        var e = [],
            ...
            j = a.count;
        if (u(b)) {
            i[Ob](k >= H.second ? 0 : j * W(i.getMilliseconds() / j));
            if (k >= H.second)
                i[Pb](k >= H.minute ? 0 : j * W(i.getSeconds() / j));
            if (k >= H.minute)
                i[Qb](k >= H.hour ? 0 : j * W(i[yb]() / j));
            if (k >= H.hour)
                i[Rb](k >= H.day ? 0 : j * W(i[zb]() / j));
            if (k >= H.day)
                i[Bb](k >= H.month ? 1 : j * W(i[$a]() / j));
            k >= H.month && (i[Cb](k >= H.year ? 0 : j * W(i[ab]() / j)), h = i[bb]());
            k >= H.year && (h -= h % j, i[Db](h));
            if (k === H.week)
                i[Bb](i[$a]() - i[Ab]() + p(d, 1));
            b = 1;
            if (ub || jb)
                i = i.getTime(), i = new ea(i + Za(i));
            h = i[bb]();
            for (var d = i.getTime(), m = i[ab](), l = i[$a](), o = (H.day + (g ? Za(i) : i.getTimezoneOffset() * 6E4)) % H.day; d < c;)
                e.push(d), k === H.year ? d = lb(h + b * j, 0) : k === H.month ? d = lb(h, m + b * j) : !g && (k === H.day || k === H.week) ? d = lb(h, m, l + b * j * (k === H.day ? 1 : 7)) : d += k * j, b++;
            e.push(d);
            n(eb(e, function (a) {
                return k <=
                    H.hour && a % H.day === o
    ...
    J.prototype.normalizeTimeTickInterval = function (a, b) {
        ...
        e === H.year &&
        a < 5 * e && (f = [1, 2, 5]);
        c = wb(a / e, f, d[0] === "year" ? x(vb(a / e), 1) : 1);
        return {
            unitRange: e,
            count: c,
            unitName: d[0]
    ...
    J.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5)
            ...
            for (var f = W(b), h, i, k, j, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
                i = e.length;
                for (h = 0; h < i && !m; h++)
                    k = Ja(sa(f) * e[h]), k > b && (!d || j <= c) && j !== s && g.push(j), j > c && (m = !0), j = k
            }
        else if (b = sa(b),
            c = sa(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = wb(a, null, vb(a)), g = za(this.getLinearTickPositions(a, b, c), Ja), !d)
    ...
    Kb.prototype = {
            ...
            var d = this.chart,
                ...
                m = function (a, b, c, d, h, i) {
                    ...
                    if (j && l)
                        ...
                        f[a] = B(i - c, m - g < 0 ? m : m - g);
                    else if (l)
                        f[a] = x(h, d + g + c > b ? d : d + g);
                    else
                        return !1
                },
                l = function (a, b, c, d) {
        ...
        refresh: function (a, b) {
            ...
            k === !1 ? this.hide() : (this.isHidden && (fb(d), d.attr("opacity",
                1).show()), d.attr({
                text: k
        ...
        getXDateFormat: function (a, b, c) {
            var d,
                ...
                i = "millisecond";
            if (e) {
                h = ia("%m-%d %H:%M:%S.%L", a.x);
                for (f in H) {
                    if (e === H.week && +ia("%w", a.x) === c.options.startOfWeek && h.substr(6) === "00:00:00.000") {
                        f = "week";
                        break
                    } else if (H[f] > e) {
                        f = i;
    ...
    var wa;
    Ya = C.documentElement.ontouchstart !== s;
    var Va = D.Pointer = function (a, b) {
        this.init(a, b)
    };
    Va.prototype = {
        init: function (a,
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (D.Tooltip && b.tooltip.enabled)
                a.tooltip = new Kb(a, b.tooltip), this.followTouchMove = p(b.tooltip.followTouchMove, !0);
            this.setDOMEvents()
        },
        ...
        runPointActions: function (a) {
            ...
            !e && g && g.directTouch && f ? l = f : (n(c, function (b) {
                ...
                j = !e && b.directTouch;
                b.visible && !k && !j && p(b.options.enableMouseTracking, !0) && (o = b.searchPoint(a, !k && b.kdDimensions === 1)) && m.push(o)
            }), n(m, function (a) {
            ...
            if (l && (l !== this.prevKDPoint || d && d.isHidden)) {
                if (e && !l.series.noSharedTooltip) {
                    for (h =
                             m.length; h--;)
                        (m[h].clientX !== l.clientX || m[h].series.noSharedTooltip) && m.splice(h, 1);
                    m.length && d && d.refresh(m, a);
                    n(m, function (b) {
                        b.onMouseOver(a, b !== (g && g.directTouch && f || l))
                    })
                } else if (d && d.refresh(l, a), !g || !g.directTouch)
                    l.onMouseOver(a);
                this.prevKDPoint = l
            } else
            ...
            if (d && !this._onDocumentMouseMove)
                this._onDocumentMouseMove = function (a) {
                    if (ba[wa])
                        ba[wa].pointer.onDocumentMouseMove(a)
                },
        ...
        reset: function (a, b) {
            ...
            if (a)
                g.refresh(h), e && (e.setState(e.state, !0), n(c.axes, function (a) {
                ...
                if (this._onDocumentMouseMove)
                    T(C, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null;
                n(c.axes, function (a) {
                    a.hideCrosshair()
                });
        ...
        drag: function (a) {
            ...
            if (!l || !l.touch)
                if (d < h ? d = h : d > h + k && (d = h + k), e < i ? e = i : e > i + j && (e = i + j), this.hasDragged = Math.sqrt(Math.pow(o - d, 2) + Math.pow(q - e, 2)), this.hasDragged >
                10) {
                    m = b.isInsidePlot(o - h, q - i);
                    if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && m && !r && !l)
                        this.selectionMarker = l = b.renderer.rect(h, i, f ? 1 : k, g ? 1 : j, 0).attr({
        ...
        onContainerClick: function (a) {
            var b = this.chart,
                ...
                a = this.normalize(a);
            a.originalEvent = a;
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (N(c.series, "click",
                v(a, {
                    point: c
        ...
        setDOMEvents: function () {
            ...
            db === 1 && z(C, "mouseup", a.onDocumentMouseUp);
            if (Ya)
                ...
                db === 1 && z(C, "touchend", a.onDocumentTouchEnd)
        },
        destroy: function () {
            var a;
            T(this.chart.container, "mouseleave", this.onContainerMouseLeave);
            db || (T(C, "mouseup", this.onDocumentMouseUp), T(C, "touchend", this.onDocumentTouchEnd));
    ...
    v(D.Pointer.prototype, {
        ...
        pinchTranslateDirection: function (a, b, c, d, e, f, g, h) {
            var i = this.chart,
                ...
                v,
                c = function () {
                    !y && P(w - u) > 20 && (p = h || P(s - x) / P(w - u));
                    r = (o - s) / p + w;
                    q = i["plot" + (a ? "Width" : "Height")] / p
                };
            c();
            b = r;
            b < t.min ? (b = t.min, v = !0) : b + q > t.max && (b = t.max - q, v = !0);
            v ? (s -= 0.8 * (s - g[k][0]), y || (x -= 0.8 * (x - g[k][1])), c()) : g[k] = [s, x];
            n || (f[k] =
                r - o, f[l] = q);
            f = n ? 1 / p : p;
            e[l] = q;
    ...
    if (S.PointerEvent || S.MSPointerEvent) {
        var Aa = {},
            ...
            Mb = function (a, b, c, d) {
                a = a.originalEvent || a;
                if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && ba[wa])
                    d(a), d = ba[wa].pointer, d[b]({
                        type: c,
        ...
        v(Va.prototype, {
            ...
            batchMSEvents: function (a) {
                ...
                a(this.chart.container, Lb ?
                    "pointermove" : "MSPointerMove", this.onContainerPointerMove);
                a(C, Lb ? "pointerup" : "MSPointerUp", this.onDocumentPointerUp)
            }
        });
        Q(Va.prototype, "init", function (a, b, c) {
            a.call(this, b, c);
        ...
        Q(Va.prototype, "setDOMEvents", function (a) {
            a.apply(this);
            (this.hasZoom || this.followTouchMove) && this.batchMSEvents(z)
        });
        Q(Va.prototype, "destroy", function (a) {
            this.batchMSEvents(T);
            a.call(this)
        })
    }
    var rb = D.Legend = function (a, b) {
        this.init(a, b)
    };
    rb.prototype = {
        init: function (a,
            ...
            this.options = b;
            if (b.enabled)
                c.itemStyle = d, c.itemHiddenStyle = A(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), z(c.chart, "endResize", function () {
        ...
        renderItem: function (a) {
            var b = this.chart,
                ...
                r = this.initialItemX,
                n = a.legendItem,
                E = a.series && a.series.drawLegendSymbol ? a.series : a,
                t = E.options,
            ...
            if (!n) {
                ...
                a.legendItem = n = c.text("", m ? f + g : -g, this.baseline ||
                    0, y).css(A(a.visible ? h : i)).attr({
                    align: m ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup);
                if (!this.baseline)
                    this.fontMetrics = c.fontMetrics(h.fontSize, n), this.baseline = this.fontMetrics.f + 3 + q, n.attr("y", this.baseline);
                E.drawLegendSymbol(this, a);
            ...
            this.setText(a);
            c = n.getBBox();
            f = a.checkboxOffset = d.itemWidth || a.legendItemWidth || f + g + c.width + j + (t ? 20 : 0);
            this.itemHeight = g = w(a.legendItemHeight || c.height);
            if (e && this.itemX - r + f > (l || b.chartWidth - 2 * k - r - d.x))
                this.itemX = r, this.itemY += q + this.lastLineHeight + o, this.lastLineHeight = 0;
            ...
            this.offsetWidth = l || x((e ? this.itemX - r - j : f) + k, this.offsetWidth)
        },
        getAllItems: function () {
            var a = [];
            n(this.chart.series, function (b) {
                var c = b.options;
                if (p(c.showInLegend, !u(c.linkedTo) ?
                    s : !1, !0))
        ...
        adjustMargins: function (a, b) {
            ...
            this.display && !d.floating && n([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (f, g) {
                f.test(e) && !u(a[g]) && (c[ob[g]] = x(c[ob[g]], c.legend[(g + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][g] * d[g % 2 ? "x" : "y"] + p(d.margin, 12) + b[g]))
            })
        },
        render: function () {
            var a = this,
            ...
            if (m || l) {
                if (i) {
                    ...
                    a.box = i = c.rect(0, 0, g, h, k.borderRadius, m || 0).attr({
        ...
        handleOverflow: function (a) {
            ...
            o.length = 0;
            if (a > f) {
                this.clipHeight = h = x(f - 20 - this.titleHeight - q, 0);
                ...
                n(F, function (a, b) {
                    var c = a._legendItemPos[1],
                        ...
                        e = o.length;
                    if (!e || c - o[e - 1] > h && (r || c) !== o[e - 1])
                        o.push(r || c), e++;
                    b === F.length - 1 && c + d - o[e - 1] > h && o.push(c);
                    c !== r && (r = c)
                });
                if (!i)
                ...
                if (!l)
                    this.nav = l = d.g().attr({
                        zIndex: 1
                    }).add(this.group), this.up = d.symbol("triangle", 0, 0, m, m).on("click",
                        function () {
                            b.scroll(-1, j)
                ...
                E(c.chartHeight), l.hide(), this.scrollGroup.attr({
                    translateY: 1
                }), this.clipHeight = 0;
            return a
        },
    ...
    L = D.LegendSymbolMixin = {
        ...
        drawLineMarker: function (a) {
            ...
            if (c && c.enabled !== !1)
                b = c.radius, this.legendSymbol = d = e.symbol(this.symbol,
                    d / 2 - b, a - b, 2 * b, 2 * b).add(f), d.isMarker = !0
        }
    };
    (/Trident\/7\.0/.test(Fa) || Ta) && Q(rb.prototype, "positionItem", function (a, b) {
        var c = this,
            d = function () {
    ...
    Ga.prototype = {
        ...
        initSeries: function (a) {
            ...
            (b = I[a.type || b.type || b.defaultSeriesType]) || pa(17, !0);
            b = new b;
            b.init(this, a);
            return b
        },
        ...
        cloneRenderTo: function (a) {
            var b = this.renderToClone,
                c = this.container;
            a ? b && (this.renderTo.appendChild(c), Ra(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), K(b, {
                position: "absolute",
                top: "-9999px",
                display: "block"
        ...
        getContainer: function () {
            ...
            this.renderer = b.forExport ? new ma(a, c, d, b.style, !0) : new Ua(a, c, d, b.style);
        ...
        getMargins: function (a) {
            ...
            this.resetMargins();
            if (d && !u(c[0]))
                this.plotTop = x(this.plotTop, d + this.options.title.margin + b[0]);
        ...
        setSize: function (a, b, c) {
            ...
            if (u(a))
                d.chartWidth = e = x(0, w(a)), d.hasUserSize = !!e;
            if (u(b))
                d.chartHeight = f = x(0, w(b));
            (i ? qb : K)(d.container, {
                width: e + "px",
                height: f + "px"
            }, i);
        ...
        setChartSize: function (a) {
            ...
            this.plotTop = k = w(this.plotTop);
            this.plotWidth = j = x(0, w(d - i - this.marginRight));
            this.plotHeight = m = x(0, w(e - k - this.marginBottom));
            ...
            this.clipBox = {
                x: b,
                y: c,
                width: W(this.plotSizeX - x(d, h[1]) / 2 - b),
                height: x(0, W(this.plotSizeY - x(d, h[2]) / 2 - c))
            };
        ...
        drawChartBox: function () {
            ...
            if (j)
                f ? f.animate(t) : this.plotBackground = b.rect(q, r, p, n, 0).attr({
                    fill: j
                }).add().shadow(a.plotShadow);
            if (m)
                h ? h.animate(t) : this.plotBGImage = b.image(m, q, r, p, n).add();
            y ? y.animate({
                width: s.width,
                height: s.height
            ...
            if (l)
                g ? g.animate(g.crisp({
                    ...
                    this.plotBorder = b.rect(q, r, p, n, 0, -l).attr({
        ...
        linkSeries: function () {
            ...
            n(b, function (b) {
                var d =
                    b.options.linkedTo;
                if (Ha(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d)))
                    d.linkedSeries.push(b), b.linkedParent = d, b.visible = p(b.options.visible, d.options.visible, b.visible)
            })
        },
        ...
        isReadyToRender: function () {
            var a = this;
            return !da && S == S.top &&
            C.readyState !== "complete" || la && !S.canvg ? (la ? Vb.push(function () {
                a.firstRender()
    ...
    O.prototype = {
        ...
        init: function (a, b) {
            ...
            for (d in e)
                z(c, d, e[d]);
            if (e && e.click ||
                b.point && b.point.events && b.point.events.click || b.allowPointSelect)
                a.runTrackerClick = !0;
            c.getColor();
            c.getSymbol();
        ...
        bindAxes: function () {
            ...
            n(a.axisTypes || [], function (e) {
                n(c[e], function (c) {
                    d = c.options;
                    if (b[e] === d.index || b[e] !== s &&
                        b[e] === d.id || b[e] === s && d.index === 0)
        ...
        autoIncrement: function () {
            ...
            if (d === "month" || d === "year")
                a = new ea(b), a = d === "month" ? +a[Cb](a[ab]() + c) : +a[Db](a[bb]() + c), c = a - b;
            this.xIncrement = b + c;
            return b
        },
        ...
        setOptions: function (a) {
            ...
            this.userOptions = a;
            c = A(e, c.series, a);
            this.tooltipOptions = A(M.tooltip, M.plotOptions[this.type].tooltip, b.tooltip, d.series && d.series.tooltip, d[this.type] && d[this.type].tooltip, a.tooltip);
        ...
        drawLegendSymbol: L.drawLineMarker,
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)
                ...
                if (o && h > o) {
                    ...
                    if (ra(j)) {
                        ...
                        if (F)
                            for (c = 0; c < h; c++)
                                i = a[c], q[c] = i[0], r[c] = i.slice(1, F + 1);
                        else
                            for (c = 0; c < h; c++)
                    ...
                    for (c = 0; c < h; c++)
                        if (a[c] !== s && (i = {
                            series: e
                        }, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), l && u(i.name)))
                            m.names[i.x] = i.name;
                Ha(r[0]) && pa(14, !0);
                e.data =
                    [];
        ...
        processData: function (a) {
            ...
            var f,
                ...
                k = this.options;
            i = k.cropThreshold;
            var j = this.isCartesian,
                m,
                l;
            if (j && !this.isDirty && !h.isDirty && !this.yAxis.isDirty && !a)
                return !1;
            if (h)
                a = h.getExtremes(), m = a.min, l = a.max;
            if (j && this.sorted && (!i || d > i || this.forceCrop))
                if (b[d - 1] < m || b[0] > l)
                    b = [], c = [];
                else if (b[0] <
                    m || b[d - 1] > l)
                    e = this.cropData(this.xData, this.yData, m, l), b = e.xData, c = e.yData, e = e.start, f = !0;
            for (i = b.length - 1; i >= 0; i--)
                d = b[i] - b[i - 1], d > 0 && (g === s || d < g) ? g = d : d < 0 && this.requireSorting && pa(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        generatePoints: function () {
            ...
            for (l = 0; l < g; l++)
                i = h + l, k ? m[l] = (new f).init(this, [d[l]].concat(oa(e[l]))) : (b[i] ? j = b[i] : a[i] !== s && (b[i] = j = (new f).init(this, a[i], d[l])), m[l] = j), m[l].index = i;
            if (b && (g !== (c = b.length) || k))
                for (l = 0; l < c; l++)
                    if (l === h && !k && (l += g), b[l])
                        b[l].destroyElements(),
        ...
        translate: function () {
            ...
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, k = i === "between" || ra(i), j = a.threshold, m = a.startFromThreshold ? j : 0, l, o, q, r = Number.MAX_VALUE, a = 0; a < g; a++) {
                var n = f[a],
                    E = n.x,
                    t = n.y;
                o = n.low;
                var y = b && e.stacks[(this.negStacks && t < (m ? 0 : j) ? "-" : "") + this.stackKey];
                if (e.isLog && t !== null && t <= 0)
                    n.y = t = null, pa(10);
                n.plotX = l = B(x(-1E5, c.translate(E,
                    0, 0, 0, 1, i, this.type === "flags")), 1E5);
                if (b && this.visible && y && y[E])
                    y = y[E], t = y.points[this.index + "," + a], o = t[0], t = t[1], o === m && (o = p(j, e.min)), e.isLog && o <= 0 && (o = null), n.total = n.stackTotal = y.total, n.percentage = y.total && n.y / y.total * 100, n.stackY = t, y.setOffset(this.pointXOffset || 0, this.barW || 0);
                n.yBottom = u(o) ? e.translate(o, 0, 1, 0, 1) : null;
                h && (t = this.modifyValue(t, n));
                n.plotY = o = typeof t === "number" && t !== Infinity ? B(x(-1E5, e.translate(t, 0, 1, 0, 1)), 1E5) : s;
                n.isInside = o !== s && o >= 0 && o <= e.len && l >= 0 && l <= c.len;
                n.clientX =
                    k ? c.translate(E, 0, 0, 0, 1) : l;
                n.negative = n.y < (j || 0);
        ...
        drawPoints: function () {
            var a,
                ...
                r,
                n = this.markerGroup,
                E = p(m.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * m.radius);
            if (m.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = W(g.plotX), e = g.plotY, j = g.graphic, o = g.marker || {}, q = !!g.marker, a = E && o.enabled === s || o.enabled, r = g.isInside, a && e !== s && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = p(o.symbol, this.symbol), k = i.indexOf("url") ===
                            0, j)
                            j[r ? "show" : "hide"](!0).animate(v({
                                x: d - h,
                                y: e - h
                            }, j.symbolName ? {
                                    width: 2 * h,
                            ...
                            if (r && (h > 0 || k))
                                g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, q ? o : m).attr(a).add(n)
                        }
                    else if (j)
                        g.graphic = j.destroy()
        },
            ...
            if (!j || g < j || k)
                for (; g--;) {
                    ...
                    if (k) {
                        ...
                        f = d.hover = d.hover || {};
                        if (!b.marker)
                            f.color = f.color || !j.options.color && e[j.negative && h ? "negativeColor" : "color"] || va(j.color).brighten(f.brightness ||
                                e.brightness).get();
                        f = {
                            color: j.color
                        };
        ...
        destroy: function () {
            ...
            n(a.axisTypes || [], function (b) {
                if (h = a[b])
                    ta(h.series, a), h.isDirty = h.forceRedraw = !0
            });
            a.legendItem &&
            ...
            for (g in a)
                a[g] instanceof Y && !a[g].survive && (d = c && g === "group" ? "hide" : "destroy", a[g][d]());
            if (b.hoverSeries === a)
                b.hoverSeries = null;
            ta(b.series, a);
            for (g in a)
        ...
        applyZones: function () {
            var a = this,
                ...
                t,
                y = !1;
            if (d.length && (i || k) && m.min !== s)
                i && i.hide(), k && k.hide(), l = m.getExtremes(), n(d, function (d, n) {
                    e = o ? r ? b.plotWidth : 0 : r ? 0 : m.toPixels(l.min);
                    e = B(x(p(f, e), 0), j);
                    f = B(x(w(m.toPixels(p(d.value, l.max), !0)), 0), j);
        ...
        invertGroups: function () {
            ...
            var b = this,
                c = b.chart;
            if (b.xAxis)
                z(c, "resize", a), z(b, "destroy", function () {
                    T(c,
                        "resize", a)
                }), a(), b.invertGroups = a
        },
    ...
    Ga.prototype.getStacks = function () {
        var a = this;
    ...
    O.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            for (E = 0; E < d; E++) {
                ...
                l[r] || (l[r] = {});
                if (!l[r][t])
                    o[r] && o[r][t] ? (l[r][t] = o[r][t], l[r][t].total = null) : l[r][t] = new Sb(m, m.options.stackLabels, q, t, h);
                r = l[r][t];
                r.points[n] = [p(r.cum, g)];
                r.touched = m.stacksTouched;
                e === "percent" ? (q = q ? i : k, j && l[q] && l[q][t] ? (q = l[q][t], r.total = q.total = x(q.total, r.total) + P(y) || 0) : r.total = ka(r.total + (P(y) || 0))) : r.total = ka(r.total + (y ||
                    0));
                r.cum = p(r.cum, g) + (y || 0);
        ...
        n([b, "-" + b], function (b) {
            ...
            for (var f = d.length, g, h; f--;)
                if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index + "," + f], g = e)
                    h = h.total ? 100 / h.total : 0, g[0] = ka(g[0] * h), g[1] = ka(g[1] * h), a.stackedYData[f] = g[1]
        })
    };
    v(Ga.prototype, {
            ...
            if (!d)
                b.loadingDiv = d = $(Sa, {
                    ...
                    v(e.style, {
                        zIndex: 10,
                        display: Z
                    }), b.container), b.loadingSpan = $("span", null, e.labelStyle, d), z(b, "redraw", f);
    ...
    v(Ba.prototype, {
        ...
        remove: function (a, b) {
            this.series.removePoint(Na(this, this.series.data), a, b)
        }
    });
    v(O.prototype, {
    ...
    Ca = ha(O, {
        ...
        getPointSpline: function (a, b, c) {
            ...
            if (f && g) {
                ...
                j += m;
                i > a && i > e ? (i =
                    x(a, e), j = 2 * e - i) : i < a && i < e && (i = B(a, e), j = 2 * e - i);
                j > g && j > e ? (j = x(g, e), i = 2 * e - j) : j < g && j < e && (j = B(g, e), i = 2 * e - j);
                b.rightContX = k;
                b.rightContY = j
            }
    ...
    Ca = ha(O, {
        ...
        getColumnMetrics: function () {
            ...
            var k = B(P(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
                j = k * b.groupPadding,
                m = (k - 2 * j) / i,
                b = B(b.maxPointWidth || c.len, p(b.pointWidth, m * (1 - 2 * b.pointPadding)));
        ...
        translate: function () {
            ...
            n(a.points, function (c) {
                var d = p(c.yBottom, f),
                    ...
                    s;
                y = x(h, d) - t;
                P(y) < g && g && (y = g, s = !e.reversed && !c.negative || e.reversed && c.negative, t = w(P(t - f) > g ? d - g : f - (s ? g : 0)));
                c.barX = n;
                c.pointWidth = i;
                E = w(n + E) + m;
                n = w(n) + m;
                ...
                y -= t;
                d && (t -= 1, y += 1);
                c.tooltipPos = b.inverted ? [e.len + e.pos - b.plotLeft - h, a.xAxis.len - n - E / 2, y] : [n + E / 2, h + e.pos - b.plotTop, y];
                c.shapeType = "rect";
                c.shapeArgs = {
                    x: n,
                    y: t,
        ...
        drawPoints: function () {
            ...
            n(a.points, function (h) {
                ...
                if (i !== s && !isNaN(i) && h.y !== null)
                    f = h.shapeArgs, i = u(a.borderWidth) ? {
                            "stroke-width": a.borderWidth
                        }
                        : {},
                        g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""],
                        k ? (fb(k), k.attr(i)[b.pointCount < e ? "animate" : "attr"](A(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
                else if (k)
                    h.graphic = k.destroy()
            })
        },
        animate: function (a) {
            var b = this.yAxis,
                ...
                e = {};
            if (da)
                a ? (e.scaleY = 0.001, a = B(b.pos + b.len, x(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] =
    ...
    R = {
        ...
        pointClass: ha(Ba, {
            ...
            setVisible: function (a, b) {
                ...
                if (a !== c.visible) {
                    c.visible =
                        c.options.visible = a = a === s ? !c.visible : a;
    ...
    O.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels)
            a.dlProcessOptions && a.dlProcessOptions(d), k = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (k.attr({
                opacity: +h
                ...
                h = p(f && f.enabled,
                    g.enabled);
                if (o && !h)
                    e.dataLabel = o.destroy();
                else if (h) {
                    d = A(g, f);
                    t = d.style;
                    h = d.rotation;
                    q = e.getLabelConfig();
                    i = d.format ? Ka(d.format, q) : d.formatter.call(q, d);
                    ...
                    if (o)
                        if (u(i))
                            ...
                            if (e.dataLabel = o = o.destroy(), n)
                                e.connector = n.destroy()
                        }
                    else if (u(i)) {
                        o = {
                        ...
                        if (t.color === "contrast")
                            y.color = d.inside || d.distance < 0 || b.stacking ?
                                j.getContrast(e.color || a.color) : "#000000";
                        if (c)
                            y.cursor = c;
                        for (r in o)
                            o[r] === s && delete o[r];
                        o = e.dataLabel = j[h ? "text" : "label"](i, 0, -999, d.shape, null, null, d.useHTML).attr(o).css(v(t, y)).add(k).shadow(d.shadow)
                    }
    ...
    if (I.pie)
        I.pie.prototype.drawDataLabels =
            function () {
                var a = this,
                    b = a.data,
                    c,
                    ...
                    for (D = 2; D--;) {
                        ...
                        if (K) {
                            a.sortByAngle(J,
                                D - 0.5);
                            for (z = b = 0; !b && J[z];)
                                b = J[z] && J[z].dataLabel && (J[z].dataLabel.getBBox().height || 21), z++;
                            if (l > 0) {
                                t = B(r + q + l, d.plotHeight);
                                for (z = x(0, r - q - l); z <= t; z += b)
                                    G.push(z);
                                t = G.length;
                                if (K > t) {
                                    c = [].concat(J);
                                ...
                                for (z = 0; z < K; z++) {
                                    ...
                                    var N,
                                        M;
                                    for (M = 0; M < t; M++)
                                        N = P(G[M] - y[1]), N < c && (c = N, H = M);
                                    if (H < z && G[z] !== null)
                                        H = z;
                                    else
                                        for (t < K - z + H && G[z] !== null && (H = t - K + z); G[H] === null;)
                                            H++;
                                    L.push({
                                        i: H,
                                        y: G[H]
                            ...
                            for (z =
                                ...
                                c = y[1];
                                if (l > 0) {
                                    if (t = L.pop(), H = t.i, v = t.y, c > v && G[H + 1] !== null || c < v && G[H - 1] !== null)
                                        v = B(x(0, c), d.plotHeight)
                                } else
                                    v = c;
                                u = e.justify ? o[0] + (D ? -1 : 1) * (q + l) : a.getX(v === r - q - l || v === r + q + l ? c : v, D);
                                E._attr = {
                                    visibility: A,
                                    align: y[6]
                                };
                                ...
                                if (this.options.size === null)
                                    t = E.width, u - t < f ? C[3] = x(w(t - u + f), C[3]) : u + t > h - f && (C[1] = x(w(u + t - h + f), C[1])), v - b / 2 < 0 ? C[0] = x(w(-v + b / 2), C[0]) :
                                        v + b / 2 > i && (C[2] = x(w(v + b / 2 - i), C[2]))
                            }
                        }
                    }
                    if (Ea(C) === 0 || this.verifyDataLabelOverflow(C))
                        this.placeDataLabels(), F && g && n(this.points, function (b) {
                            k = b.connector;
                            y = b.labelPos;
                            if ((E = b.dataLabel) && E._pos && b.visible)
                                A = E._attr.visibility, u = E.connX, v = E.connY, j = m ? ["M", u + (y[6] === "left" ? 5 : -5), v, "C", u, v, 2 * y[2] - y[4], 2 * y[3] - y[5], y[2], y[3], "L", y[4], y[5]] : ["M", u + (y[6] === "left" ? 5 : -5), v, "L", y[2], y[3], "L", y[4], y[5]], k ? (k.animate({
                                    d: j
                                }), k.attr("visibility", A)) : b.connector = k = a.chart.renderer.path(j).attr({
                                    "stroke-width": g,
            ...
            I.pie.prototype.placeDataLabels = function () {
                n(this.points, function (a) {
                    var b = a.dataLabel;
                    if (b && a.visible)
                        (a = b._pos) ? (b.attr(b._attr), b[b.moved ? "animate" : "attr"](a), b.moved = !0) : b && b.attr({
                            y: -999
                        })
                })
            },
            I.pie.prototype.alignDataLabel = ja,
            I.pie.prototype.verifyDataLabelOverflow = function (a) {
                var b = this.center,
                    ...
                    f = e,
                    g;
                d[0] !== null ? f = x(b[2] - x(a[1], a[3]), e) : (f = x(b[2] - a[1] - a[3],
                    e), b[0] += (a[3] - a[1]) / 2);
    ...
    (function (a) {
        ...
        b.prototype.hideOverlappingLabels = function (a) {
            ...
            for (e = 0; e < b; e++) {
                k = a[e];
                for (d = e + 1; d < b; ++d)
                    if (j = a[d], k && j && k.placed && j.placed && k.newOpacity !== 0 && j.newOpacity !== 0 && (m = k.alignAttr, l = j.alignAttr, o = 2 * (k.box ? 0 : k.padding), m = !(l.x > m.x + (k.width - o) || l.x + (j.width - o) < m.x || l.y > m.y + (k.height - o) || l.y + (j.height - o) < m.y)))
                ...
                if (a) {
                    ...
                    if (a.oldOpacity !== c && a.placed)
                        c ? a.show(!0) : b = function () {
                            ...
                            a[a.isOld ? "animate" : "attr"](a.alignAttr, null,
                                b);
                    a.isOld = !0
                }
            })
    ...
    var ib = D.TrackerMixin = {
        ...
        drawTrackerGraph: function () {
            ...
            if (e && !c)
                for (l = e + 1; l--;)
                    d[l] === "M" && d.splice(l + 1, 0, d[l + 1] - i, d[l + 2], "L"), (l && d[l] === "M" || l === e) && d.splice(l, 0, "L", d[l - 2] + i, d[l -
                    1]);
            for (l = 0; l < j.length; l++)
                e = j[l], d.push("M", e.plotX - i, e.plotY, "L", e.plotX + i, e.plotY);
            k ? k.attr({
                d: d
    ...
    if (I.column)
        Ca.prototype.drawTracker = ib.drawTrackerPoint;
    if (I.pie)
        I.pie.prototype.drawTracker = ib.drawTrackerPoint;
    if (I.scatter)
        xa.prototype.drawTracker = ib.drawTrackerPoint;
    v(rb.prototype, {
        ...
        pan: function (a, b) {
            ...
            n(b === "xy" ? [1, 0] : [1], function (b) {
                var d = a[b ? "chartX" : "chartY"],
                    ...
                    i = i > d;
                if (h.series.length && (i || m > B(j.dataMin, j.min)) &&
                    (!i || k < x(j.dataMax, j.max)))
                    h.setExtremes(m, k, !1, !1, {
                        trigger: "pan"
                    }), e = !0;
    ...
    v(Ba.prototype, {
        select: function (a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", {
                ...
                b || n(e.getSelectedPoints(), function (a) {
                    if (a.selected && a !== c)
                        a.selected = a.options.selected = !1, d.options.data[Na(a,
        ...
        setState: function (a, b) {
            ...
            if (!(a === this.state && !b || this.selected &&
                ...
                if (this.graphic)
                    g = g && this.graphic.symbolName && q.r, this.graphic.attr(A(q, g ? {
                            x: c - g,
                            y: d - g,
                            width: 2 * g,
                            height: 2 * g
                    ...
                    if (a && i)
                        if (g = i.radius, m = m.symbol || e.symbol, j && j.currentSymbol !== m && (j = j.destroy()), j)
                            j[b ? "animate" : "attr"]({
                                x: c - g,
                                y: d - g
                            });
                        else if (m)
                            e.stateMarkerGraphic = j = l.renderer.symbol(m, c - g, d - g, 2 * g, 2 * g).attr(q).add(e.markerGroup), j.currentSymbol = m;
                    if (j)
                        j[a && l.isInsidePlot(c,
                            d, l.inverted) ? "show" : "hide"](), j.element.point = this
                }
                if ((c = f[a] && f[a].halo) && c.size) {
                    if (!o)
                        e.halo = o = l.renderer.path().add(l.seriesGroup);
                    o.attr(v({
    ...
    Q(J.prototype, "getTimeTicks", function (a, b, c, d, e, f, g, h) {
        var i = 0,
            k = 0,
            j,
            m = {},
        ...
        if (!this.options.ordinal && !this.options.breaks || !f || f.length < 3 || c === s)
        ...
        for (o = f.length; k < o; k++) {
            ...
            if (k === o - 1 || f[k + 1] - f[k] > g * 5 || q) {
                if (f[k] > n) {
                    for (j = a.call(this, b, f[i], f[k], e); j.length && j[0] <= n;)
                        j.shift();
        ...
        if (h && a.unitRange <= H.hour) {
            k = r.length - 1;
            for (i = 1; i < k; i++)
                ia("%d", r[i]) !== ia("%d", r[i - 1]) && (m[r[i]] = "day", l = !0);
            l && (m[r[0]] = "day");
            a.higherRanks = m
        }
        r.info = a;
        if (h && u(p)) {
            var h = a = r.length,
                ...
                t;
            for (l = []; h--;)
                i = this.translate(r[h]), t && (l[h] = t - i), k[h] = t = i;
            l.sort();
            l = l[W(l.length / 2)];
            l < p * 0.6 && (l = null);
            h = r[a - 1] > d ? a - 1 : a;
        ...
        lin2val: function (a, b) {
            ...
            if (c) {
                var d = this.ordinalSlope,
                    ...
                    h;
                if (b)
                    a < 0 ? a = c[0] : a > f ? a = c[f] : (f = W(a), h = a - f);
                else
                    for (; f--;)
                        if (g = d * f + e, a >= g) {
                            d = d * (f + 1) + e;
            ...
            if (l.ordinalPositions) {
                if (P(f) > 1)
                    j && n(j, function (a) {
                        ...
                        null, m.apply(j, [o.apply(j, [i, !0]) + f, !0]), m.apply(q, [o.apply(q, [k, !0]) + f, !0])), f.min >= B(g.dataMin, i) && f.max <= x(h, k) && c.setExtremes(f.min, f.max, !0, !1, {
                        trigger: "pan"
    ...
    Q(O.prototype, "getSegments", function (a) {
        ...
        a.apply(this, Array.prototype.slice.call(arguments, 1));
        if (c)
            b = this.segments, n(b, function (a, f) {
    ...
    (function (a) {
        ...
        e(g.prototype, {
            ...
            isInAnyBreak: function (a, b) {
                ...
                if (e) {
                    for (; e--;)
                        this.isInBreak(d[e], a) && (f = !0, g || (g = c(d[e].showPoints, this.isXAxis ? !1 : !0)));
                    h = f && b ? f && !g : f
                }
                return h
            }
            ...
            if (this.options.breaks) {
                ...
                this.setAxisTranslation = function (a) {
                    ...
                    var b = d.options.breaks,
                        ...
                        p;
                    for (p in b)
                        i = b[p], h = i.repeat || Infinity, d.isInBreak(i, j) && (j += i.to % h - j % h), d.isInBreak(i, k) && (k -= k % h - i.from % h);
                    for (p in b) {
                        i = b[p];
                        n = i.from;
                        for (h = i.repeat || Infinity; n - h > j;)
                            n -= h;
                        for (; n < j;)
                            n += h;
                        for (; n < k; n += h)
        ...
        d(h.prototype, "generatePoints", function (a) {
            ...
            if (c && d && (c.options.breaks || d.options.breaks))
                for (; g--;)
                    if (f = e[g], n = f.y === null && h === !1, !n && (c.isInAnyBreak(f.x, !0) || d.isInAnyBreak(f.y, !0)))
        ...
        d(a.seriesTypes.column.prototype, "drawPoints", function (a) {
            ...
            for (n = 0; n < a.length; n++) {
                ...
                for (p =
                    ...
                    q = d[p];
                    g = !1;
                    if (e < q.from && s > q.to || e > q.from && s < q.from)
                        g = "pointBreak";
                    else if (e < q.from && s > q.from && s < q.to || e > q.from && s > q.to && s < q.from)
                        g = "pointInBreak";
                    g && f(b, g, {
                        point: h,
                        brk: q
    ...
    var ca = O.prototype,
        R = Kb.prototype,
        ic = ca.processData,
        jc = ca.generatePoints,
        kc = ca.destroy,
        lc = R.tooltipFooterHeaderFormatter,
        mc = {
        ...
        Oa = {
            ...
            low: function (a) {
                return a.length ? Qa(a) : a.hasNulls ? null : s
            },
            close: function (a) {
    ...
    ca.groupData = function (a,
        ...
        for (r = 0; r <= i; r++)
            if (a[r] >= c[0])
                break;
        for (; r <= i; r++) {
            for (; c[1] !== s && a[r] >= c[1] || r === i;)
                if (k = c.shift(), j = d.apply(0, l), j !== s && (g.push(k), h.push(j)), l[0] = [], l[1] = [], l[2] = [], l[3] = [], r === i)
                    break;
            if (r === i)
                break;
            if (o) {
                ...
                for (j = 0; j < n; j++)
                    ...
                    typeof p === "number")
                        ...
                        l[j].hasNulls = !0
            } else if (k = m ? b[r] : null, typeof k === "number")
                l[0].push(k);
            else if (k === null)
                l[0].hasNulls = !0
        }
        ...
        if (ic.apply(this, arguments) !== !1 && d) {
            ...
            if (k) {
                ...
                var j = a.getExtremes(),
                    ...
                    g = ca.groupData.apply(this, [f, g, k, c.approximation]),
                    f = g[0],
                    g = g[1];
                if (c.smoothed) {
                    c = f.length - 1;
    ...
    R.tooltipFooterHeaderFormatter = function (a, b) {
        var c = a.series,
            ...
            g,
            h = c.xAxis;
        h && h.options.type === "datetime" && e && ra(a.key) ? (c = c.currentDataGrouping, e = e.dateTimeLabelFormats, c ? (h = e[c.unitName], c.count === 1 ? f = h[0] : (f = h[1], g = h[2])) : !f && e && (f = this.getXDateFormat(a, d, h)), f = ia(f, a.key), g && (f += ia(g, a.key + c.totalRange - 1)), d = d[(b ? "footer" : "header") + "Format"].replace("{point.key}", f)) : d = lc.call(this,
            a, b);
        return d
    };
    ca.destroy = function () {
    ...
    Q(ca, "setOptions", function (a, b) {
        var c = a.call(this, b),
            d = this.type,
            e = this.chart.options.plotOptions,
            f = U[d].dataGrouping;
        if (Wb[d])
            f || (f = A(mc, Wb[d])), c.dataGrouping = A(f, e.series && e.series.dataGrouping, e[d].dataGrouping, b.dataGrouping);
        if (this.chart.options._stock)
            this.requireSorting = !0;
        return c
    });
    Q(J.prototype, "setScale", function (a) {
        a.call(this);
        n(this.series, function (a) {
            a.hasProcessed =
                !1
    ...
    J.prototype.getGroupPixelWidth = function () {
        var a = this.series,
            ...
            f;
        for (c = b; c--;)
            (f = a[c].options.dataGrouping) && (d = x(d, f.groupPixelWidth));
        for (c = b; c--;)
    ...
    R = ha(I.column, {
        ...
        drawPoints: function () {
            ...
            n(a.points, function (j) {
                if (j.plotY !== s)
                    i = j.graphic, c = j.pointAttr[j.selected ? "selected" : ""] || a.pointAttr[""], f = c["stroke-width"] % 2 / 2, k = w(j.plotX) - f, g = w(j.shapeArgs.width / 2), h = ["M", k, w(j.yBottom), "L", k, w(j.plotY)], j.open !== null && (d = w(j.plotOpen) + f, h.push("M", k, d, "L", k - g, d)), j.close !== null && (e = w(j.plotClose) + f, h.push("M", k, e, "L", k + g, e)), i ?
                        i.attr(c).animate({
                            d: h
    ...
    R = ha(R, {
        ...
        getAttribs: function () {
            ...
            n(this.points, function (a) {
                if (a.open < a.close) {
                    if (a.lineColor)
                        a.pointAttr = A(a.pointAttr), c = a.lineColor;
        ...
        drawPoints: function () {
            ...
            n(a.points, function (n) {
                l = n.graphic;
                if (n.plotY !== s)
                    c = n.pointAttr[n.selected ? "selected" : ""] || d, j = c["stroke-width"] % 2 / 2, m = w(n.plotX) - j, e = n.plotOpen, f = n.plotClose, g = X.min(e, f), h = X.max(e,
                        f), q = w(n.shapeArgs.width / 2), i = w(g) !== w(n.plotY), k = h !== n.yBottom, g = w(g) + j, h = w(h) + j, o = ["M", m - q, h, "L", m - q, g, "L", m + q, g, "L", m + q, h, "Z", "M", m, g, "L", m, i ? w(n.plotY) : g, "M", m, h, "L", m, k ? w(n.yBottom) : h], l ? l.attr(c).animate({
                        d: o
    ...
    I.flags = ha(I.column, {
        ...
        translate: function () {
            ...
            if (d && d.visible && h) {
                ...
                for (b.sort(function (a, b) {
                    ...
                    if (d = b[c], j = g[h], j.x <= d.x && j.plotY !== s) {
                        if (d.x <= m)
                            d.plotY = j.plotY, j.x < d.x && !f && (l = g[h + 1]) && l.plotY !== s && (d.plotY += (d.x - j.x) / (l.x - j.x) * (l.plotY - j.plotY));
                        c--;
                        h++;
                        if (c < 0)
                            break
            ...
            n(b, function (c, d) {
                var f;
                if (c.plotY === s)
                    c.x >= k.min && c.x <= k.max ? c.plotY = a.chartHeight - i.bottom - (i.opposite ? i.height : 0) + i.offset -
        ...
        drawPoints: function () {
            ...
            for (k = c.length; k--;)
                ...
                e >= 0 && !a)
                    a = j.pointAttr[j.selected ? "select" : ""] || b, m ? m.attr({
                        x: e,
                        y: f,
                        r: a.r,
                        anchorX: l,
                        anchorY: o
                    }) : j.graphic = d.label(j.options.title || g.title || "A", e, f, i, l, o, g.useHTML).css(A(g.style, j.style)).attr(a).attr({
    ...
    Ua ===
    D.VMLRenderer && n(["flag", "circlepin", "squarepin"], function (a) {
        hb.prototype.symbols[a] = sb[a]
    });
    var R = [].concat(Xb),
        tb = function (a) {
            var b = eb(arguments, function (a) {
                return typeof a === "number"
            });
            if (b.length)
    ...
    Eb.prototype = {
        ...
        render: function (a, b, c, d) {
            ...
            if (u(a) && !isNaN(a)) {
                ...
                m.getExtremes && (L = this.getUnionExtremes(!0)) && (L.dataMin !== m.min || L.dataMax !== m.max) && m.setExtremes(L.dataMin, L.dataMax, !0, !1);
                c = p(c, m.translate(a));
                d = p(d, m.translate(b));
                if (isNaN(c) || P(c) === Infinity)
                    c = 0, d = k;
                if (!(m.translate(d, !0) - m.translate(c, !0) < e.xAxis[0].minRange)) {
                    this.zoomedMax = B(x(c, d), h);
                    this.zoomedMin = x(this.fixedWidth ?
                        this.zoomedMax - this.fixedWidth : B(c, d), 0);
                    ...
                    if (!this.rendered) {
                        if (A)
                            this.navigatorGroup = m = f.g("navigator").attr({
                                zIndex: 3
                        ...
                        if (r)
                            this.scrollbarGroup = j = f.g("scrollbar").add(),
                                l = v.trackBorderWidth, this.scrollbarTrack = o = f.rect().attr({
                                x: 0,
                                y: -l % 2 / 2,
                    ...
                    if (A) {
                        ...
                        this.outline[e]({
                            d: ["M", i, I, "L", g + b - C, I, g + b - C, I + H, "L", g + c - C, I + H, "L", g + c - C, I, i + k, I].concat(s.maskInside ? ["M", g + b + C, I, "L", g + c - C, I] : [])
                        });
                        this.drawHandle(b + C, 0);
                        this.drawHandle(c + C, 1)
                    }
                    if (r && j)
                        this.drawScrollbarButton(0), this.drawScrollbarButton(1), j[e]({
                            translateX: i,
                            translateY: w(I + y)
                        }), o[e]({
                            width: k
                        }), g = n + b, h = a - K, h < t && (G = (t - h) / 2, h = t, g -= G), this.scrollbarPad = G, l[e]({
                            x: W(g) + K % 2 / 2,
                            width: h
                        }), t = n + b + a / 2 - 0.5, this.scrollbarRifles.attr({
                            visibility: a >
                            12 ? "visible" : "hidden"
                        })[e]({
                            d: ["M", t - 3, n / 4, "L", t - 3, 2 * n / 3, "M", t, n / 4, "L", t, 2 * n / 3, "M", t + 3, n / 4, "L", t + 3, 2 * n / 3]
                        });
                    this.scrollbarPad = G;
                    this.rendered = !0
                }
        ...
        addEvents: function () {
            ...
            Ya && e.push([a, "touchstart", b], [a, "touchmove", c], [document, "touchend", d]);
            n(e, function (a) {
                z.apply(null, a)
            });
            this._events = e
        ...
        init: function () {
            ...
            a.mouseDownHandler = function (d) {
                ...
                if (w >
                    h && w < h + g + j)
                    if ((h = !a.scrollbarEnabled || w < h + g) && X.abs(u - e - m) < x)
                        a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null;
                    else if (h && X.abs(u - f - m) < x)
                        a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null;
                    else if (u > m + e - p && u < m + f + p)
                        a.grabbedCenter = u, a.fixedWidth = s, i = u - e;
                    else if (u > k && u < k + l) {
                        f = h ? u - m - s / 2 : u < m ? e - s * 0.2 : u > k + l - j ? e + s * 0.2 : u < m + e ? e - s : f;
                        if (f < 0)
                            f = 0;
                        else if (f + s >= n)
                            f = n - s, v = a.getUnionExtremes().dataMax;
                        if (f !== e)
                            a.fixedWidth = s, e = c.toFixedRange(f, f + s, null, v), d.setExtremes(e.min,
                                e.max, !0, !1, {
                                    trigger: "navigator"
                                })
                    }
            ...
            a.mouseUpHandler = function (d) {
                ...
                if (d.type !== "mousemove")
                    a.grabbedLeft = a.grabbedRight = a.grabbedCenter = a.fixedWidth = a.fixedExtreme = a.otherHandlePos = k = i = null
            };
            var m = b.xAxis.length,
                l = b.yAxis.length;
            b.extraBottomMargin = a.outlineHeight + f.margin;
            a.navigatorEnabled ? (a.xAxis = c = new J(b, A({
                ...
                index: l,
                zoomEnabled: !1
            })), j || f.series.data ? a.addBaseSeries() : b.series.length === 0 && Q(b, "redraw", function (c,
                                                                                                            d) {
        ...
        addBaseSeries: function () {
            ...
            if (a && this.navigatorOptions.adaptToUpdatedData !==
                !1)
                z(a, "updatedData", this.updatedDataHandler), a.userOptions.events = v(a.userOptions.event, {
        ...
        updatedDataHandler: function () {
            ...
            if (!a.hasNavigatorData)
                o.options.pointStart = b.xData[0], o.setData(b.options.data, !1), l = !0;
            i && (m = g, j = m + h);
            k && (j = d, i || (m = x(j -
                h, o.xData[0])));
            n && (i || k) ? isNaN(m) || c.setExtremes(m, j, !0, !1, {
                trigger: "updatedData"
            }) : (l && this.chart.redraw(!1), a.render(x(e, g), B(f, d)))
        },
        destroy: function () {
            this.removeEvents();
    ...
    D.Scroller = Eb;
    Q(J.prototype, "zoom", function (a, b, c) {
        var d = this.chart,
            e = d.options,
            f = e.chart.zoomType,
            g = e.navigator,
        ...
        if (this.isXAxis && (g && g.enabled || e && e.enabled))
            if (f === "x")
                ...
                d = this.previousZoom, u(b) ? this.previousZoom = [this.min, this.max] : d && (b = d[0], c = d[1], delete this.previousZoom);
        ...
        "init", function (a, b, c) {
            z(this, "beforeRender", function () {
                ...
                if (a.navigator.enabled || a.scrollbar.enabled)
                    this.scroller = new Eb(this)
            });
            a.call(this, b, c)
        });
    Q(O.prototype, "addPoint", function (a, b, c, d, e) {
        var f = this.options.turboThreshold;
        f && this.xData.length > f && ga(b) && !Ia(b) && this.chart.scroller && pa(20, !0);
        a.call(this, b, c, d, e)
    });
    v(M, {
        rangeSelector: {
    ...
    Fb.prototype = {
        clickButton: function (a, b) {
            ...
            if (!(k === null || j === null || a === c.selected)) {
                e.fixedRange = i;
                if (t)
                    this.forcedDataGrouping = !0, J.prototype.setDataGrouping.call(h || {
                        chart: this.chart
                    }, t, !1);
                if (o === "month" || o === "year")
                    if (h) {
                        if (o = {
                            ...
                            dataMin: k,
                            dataMax: j
                        }, m = h.minFromRange.call(o), typeof o.newMax === "number")
                            l = o.newMax
                    } else
                        i = g;
                else if (i)
                    ...
                    if (h) {
                        if (j === s)
                            k = Number.MAX_VALUE, j = Number.MIN_VALUE, n(e.series, function (a) {
                                a = a.xData;
                                k = B(a[0], k);
                                j = x(a[a.length - 1], j)
                            }), b = !1;
                ...
                }), c.setSelected(a)) : (q = e.options.xAxis[0], v = q.range, q.range = i, u = q.min, q.min = r, c.setSelected(a), z(e, "load", function () {
                    q.range = v;
                    q.min = u
                }))
            }
        ...
        updateButtonStates: function (a) {
            var b = this,
                ...
                k =
                    b.buttons;
            a && c.fixedRange !== w(d.max - d.min) && (k[h] && k[h].setState(0), b.setSelected(null));
            n(b.buttonOptions, function (a, e) {
                var l = w(d.max - d.min),
                    ...
                    s = o > g - f,
                    u = o < d.minRange,
                    t = a.type === "all" && d.max - d.min >= g - f && k[e].state !== 2,
                    y = a.type === "ytd" && ia("%Y", f) === ia("%Y", g),
                ...
                if ((n === "month" || n === "year") && l >= {
                    ...
                    [n] * 864E5 * p)
                    o = !0;
                v || o && e !== h ? (b.setSelected(e), k[e].setState(2)) : !i && (s || u || t || y) ? k[e].setState(3) :
        ...
        setInputValue: function (a, b) {
            ...
            this[a + "Input"].value = ia(c.inputEditDateFormat || "%Y-%m-%d", this[a + "Input"].HCTime);
            this[a + "DateBox"].attr({
        ...
        drawInput: function (a) {
            ...
            i.onchange = function () {
                var a = i.value,
                    ...
                    g = e.dataMin,
                    j = e.dataMax;
                isNaN(d) && (d = a.split("-"), d = ea.UTC(G(d[0]), G(d[1]) - 1, G(d[2])));
                isNaN(d) || (M.global.useUTC || (d += (new ea).getTimezoneOffset() * 6E4), h ? d > b.maxInput.HCTime ?
        ...
        getPosition: function () {
            var a = this.chart,
                a = p((a.options.rangeSelector.buttonPosition || {}).y, a.plotTop - a.axisOffset[0] - 35);
            return {
                buttonTop: a,
                inputTop: a - 10
            }
        ...
        render: function (a, b) {
            var c = this,
                ...
                t = c.group,
                y = c.rendered;
            if (!y && (c.group = t = e.g("range-selector-buttons").add(), c.zoomText = e.text(g.rangeSelectorZoom, p(l.x, r), 15).css(i.labelStyle).add(t), s = p(l.x, r) + c.zoomText.getBBox().width + 5, n(c.buttonOptions, function (a, b) {
                ...
                s += k[b].width + p(i.buttonSpacing, 5);
                c.selected ===
                b && k[b].setState(2)
            }), c.updateButtonStates(), o !== !1))
                c.div = j = $("div", null, {
                    position: "relative",
                    height: 0,
                    zIndex: 1
            ...
            o !== !1 && (j.align(v({
                y: w.inputTop,
                width: j.offset,
                x: h && w.inputTop < (h.y || 0) + h.height - d.spacing[0] ? -40 : 0
            }, i.inputPosition), !0, d.spacingBox), u(o) || (d = t.getBBox(), j[j.translateX < d.x + d.width + 10 ? "hide" : "show"]()), c.setInputValue("min",
                a), c.setInputValue("max", b));
            c.rendered = !0
        },
        destroy: function () {
            var a = this.minInput,
            ...
            for (e in this)
                this[e] && e !== "chart" && (this[e].destroy ? this[e].destroy() : this[e].nodeType && Ra(this[e])), this[e] = null
        }
    };
    ...
    J.prototype.minFromRange = function () {
        var a = this.range,
            ...
            d = new ea(c),
            e;
        typeof a === "number" ? (b = this.max - a, e = a) : (d["set" + b](d["get" + b]() - a.count), b = d.getTime());
        a = p(this.dataMin, Number.MIN_VALUE);
        isNaN(b) && (b = a);
        if (b <= a)
            b = a, this.newMax = B(b + e, this.dataMax);
        isNaN(c) && (b = void 0);
        return b
    };
    Q(Ga.prototype, "init", function (a, b, c) {
    ...
    D.RangeSelector = Fb;
    Ga.prototype.callbacks.push(function (a) {
        function b() {
        ...
        h && (z(a.xAxis[0],
            "afterSetExtremes", e), z(a, "resize", c), c());
        z(a, "destroy", function () {
            g && T(a.xAxis[0], "afterSetExtremes", d);
    ...
    D.StockChart = function (a, b) {
        var c = a.series,
            d,
            e = p(a.navigator && a.navigator.enabled, !0) ? {
                    startOnTick: !1,
                    endOnTick: !1
                }
                : null,
    ...
    Q(J.prototype, "autoLabelAlign", function (a) {
        var b = this.chart,
            c = this.options,
    ...
    Q(J.prototype, "getPlotLinePath", function (a, b, c, d, e, f) {
        ...
        v = g.isXAxis ? u(g.options.yAxis) ? [i.yAxis[g.options.yAxis]] : za(h, function (a) {
            return a.yAxis
        }) : u(g.options.xAxis) ?
            [i.xAxis[g.options.xAxis]] : za(h, function (a) {
                return a.xAxis
            });
        ...
        t = v.length ? [] : [g.isXAxis ? i.yAxis[0] : i.xAxis[0]];
        n(v, function (a) {
            Na(a, t) === -1 && t.push(a)
        });
        ...
        isNaN(f) || (g.horiz ? n(t, function (a) {
            ...
            o = r = w(m + g.height - f);
            if (o < m || o > m + g.height)
                e ? o = r = B(x(m, o), g.top + g.height) : b = !0;
            b || s.push("M", l, o, "L", q, r)
        }));
    ...
    ma.prototype.crispPolyLine = function (a, b) {
        ...
        for (c = 0; c < a.length; c += 6)
            a[c + 1] === a[c + 4] && (a[c + 1] = a[c + 4] = w(a[c + 1]) - b % 2 / 2), a[c + 2] === a[c + 5] && (a[c + 2] = a[c + 5] = w(a[c + 2]) + b % 2 / 2);
        return a
    };
    if (Ua === D.VMLRenderer)
        hb.prototype.crispPolyLine = ma.prototype.crispPolyLine;
    Q(J.prototype, "hideCrosshair", function (a, b) {
        a.call(this, b);
        u(this.crossLabelArray) && (u(b) ? this.crossLabelArray[b] && this.crossLabelArray[b].hide() : n(this.crossLabelArray, function (a) {
            a.hide()
        }))
    });
    Q(J.prototype, "drawCrosshair", function (a,
                                              b, c) {
        var d,
            e;
        a.call(this, b, c);
            ...
            if (l < k || l > k + this.height)
                ...
                if (b) {
                    if (this.options.tickPosition ===
                        "inside" && !h || this.options.tickPosition !== "inside" && h)
                        l = j.y - c.height
                } else
                    l = j.y - c.height / 2;
    ...
    var nc = ca.init,
        oc = ca.processData,
        pc = Ba.prototype.tooltipFormatter;
    ca.init = function () {
    ...
    Ba.prototype.tooltipFormatter = function (a) {
        a = a.replace("{point.change}", (this.change > 0 ? "+" : "") + D.numberFormat(this.change, p(this.series.tooltipOptions.changeDecimals, 2)));
        return pc.apply(this, [a])
    };
    Q(O.prototype, "render", function (a) {
        if (this.chart.options._stock &&
            this.xAxis)
            !this.clipBox && this.animate ? (this.clipBox = A(this.chart.clipBox), this.clipBox.width = this.xAxis.len, this.clipBox.height = this.yAxis.len) : this.chart[this.sharedClipKey] && (fb(this.chart[this.sharedClipKey]), this.chart[this.sharedClipKey].attr({
