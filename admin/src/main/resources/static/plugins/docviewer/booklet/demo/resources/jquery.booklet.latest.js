...
;(function ($) {
    ...
    function Booklet(inTarget, inOptions) {
        var target = inTarget,
            ...
            //control vars
            p3drag, p0drag, ctrls, overlaysB, overlayN, overlayP, tabs, tabN, tabP, arrows, arrowN, arrowP, customN,
            customP, ctrlsN, ctrlsP, menu, pause, play,
            ...
            initPages = function () {
                ...
                if (options.closed) {
                    $(templates.empty).attr({
                        title: options.closedFrontTitle || '',
                        rel: options.closedFrontChapter || ''
                    }).prependTo(target);
                    target.children().last().attr({
                        title: options.closedBackTitle || '',
                        rel: options.closedBackChapter || ''
                    });
            ...
            updateManualControls = function () {
                var origX, newX, diff, fullPercent, shadowPercent, shadowW, curlW, underW, targetPercent, curlLeft,
                    p1wrapLeft;
