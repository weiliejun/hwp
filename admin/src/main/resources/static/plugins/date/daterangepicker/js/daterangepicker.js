...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
            ...
            '</div>' +
            '<button style="margin-left:16px;" class="btn btn-small btn-success" disabled="disabled">' + this.locale.applyLabel + '</button>' +
            '</div>' +
            '</div>' +
            '</div>';
    ...
    DateRangePicker.prototype = {
        ...
        updateFromControl: function () {
            ...
            var dateString = this.element.val().split(" 至 ");
        ...
        notify: function () {
            ...
            if (this.element.is('input')) {
                this.element.val(this.startDate.toString(this.format) + ' 至 ' + this.endDate.toString(this.format));
            }
            this.cb(this.startDate, this.endDate);
        },
