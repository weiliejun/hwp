...
package cn.exclusive.emay.sdk.client.api;

import cn.exclusive.b2m.eucp.sdkhttp.SDKServiceBindingStub;
import cn.exclusive.b2m.eucp.sdkhttp.SDKServiceLocator;
...
public class Client {
    ...
    public List getMO() throws RemoteException {
        cn.exclusive.b2m.eucp.sdkhttp.Mo mo[] = binding.getMO(softwareSerialNo, key);
        if (mo == null) {
            return null;
        } else {
    ...
    public List getReport() throws RemoteException {
        cn.exclusive.b2m.eucp.sdkhttp.StatusReport sr[] = binding.getReport(softwareSerialNo, key);
        if (sr != null)
