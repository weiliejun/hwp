...
public class StatusReport implements java.io.Serializable {
    ...
    public StatusReport(String errorCode, String memo, String mobile, String receiveDate, int reportStatus, long seqID, String serviceCodeAdd, String submitDate) {
    ...
    public synchronized boolean equals(Object obj) {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = true && ((this.errorCode == null && other.getErrorCode() == null) || (this.errorCode != null && this.errorCode.equals(other.getErrorCode()))) && ((this.memo == null && other.getMemo() == null) || (this.memo != null && this.memo.equals(other.getMemo()))) && ((this.mobile == null && other.getMobile() == null) || (this.mobile != null && this.mobile.equals(other.getMobile()))) && ((this.receiveDate == null && other.getReceiveDate() == null) || (this.receiveDate != null && this.receiveDate.equals(other.getReceiveDate()))) && this.reportStatus == other.getReportStatus() && this.seqID == other.getSeqID() && ((this.serviceCodeAdd == null && other.getServiceCodeAdd() == null) || (this.serviceCodeAdd != null && this.serviceCodeAdd.equals(other.getServiceCodeAdd())))
