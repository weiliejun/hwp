...
public class SDKServiceLocator extends org.apache.axis.client.Service implements SDKService {
    ...
    private String SDKService_address = "http://sdk4report.eucp.b2m.cn:8080/sdk/SDKService?wsdl";
    ...
    public SDKClient getSDKService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.share.b2m.eucp.sdkhttp.SDKServiceBindingStub _stub = new cn.share.b2m.eucp.sdkhttp.SDKServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SDKClient.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.share.b2m.eucp.sdkhttp.SDKServiceBindingStub _stub = new cn.share.b2m.eucp.sdkhttp.SDKServiceBindingStub(new java.net.URL(SDKService_address), this);
                _stub.setPortName(getSDKServiceWSDDServiceName());
                return _stub;
            }
        } catch (Throwable t) {
