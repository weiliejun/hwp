...
public class JSONParserTokenManager implements JSONParserConstants {
     ...
     */
    public static final String[] jjstrLiteralImages = {"", null, null, null, null, "\164\162\165\145", "\146\141\154\163\145", "\156\165\154\154", null, null, null, null, null, null, null, null, null, null, "\173", "\72", "\54", "\175", "\133", "\135",};
    /**
     * Lexer state names.
     */
    ...
    static final int[] jjnextStates = {30, 31, 36, 37, 40, 41, 8, 19, 20, 22, 10, 11, 13, 45, 47, 2, 4, 5, 8, 10, 11, 15, 13, 19, 20, 24, 22, 32, 33, 8, 40, 41, 8, 6, 7, 12, 14, 16, 21, 23, 25, 34, 35, 38, 39, 42, 43,};
    static final long[] jjtoToken = {0xfcd1e1L,};
                    ...
                    switch (jjstateSet[--i]) {
                        case 0:
                            if ((0x3ff000000000000L & l) != 0L)
                                ...
                                jjCheckNAdd(4);
                            if ((0x3fe000000000000L & l) != 0L || curChar == 45) // 负号
                            {
                                if (kind > 8)
                                    kind = 8;
