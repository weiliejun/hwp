...
import com.hwp.common.constant.ResultCode;
...
import com.hwp.common.util.MD5Util;
import com.hwp.common.util.StringHelper;
import com.hwp.common.util.UUIDUtil;
...
public class UserInfoServiceImpl implements UserInfoService {
    ...
    public Map<String, String> userRegisterSubmit(String mobile, String password, String nickName) {
        ...
        try {
            ...
            user.setCreateTime(DateHelper.getYMDHMSFormatDate(new Date()));
    ...
    public Map<String, String> login(String userName, String password, String ip, String sid, String exitVerifyCode, String validateCode) {
        ...
        //账户有效校验，0：无效；1有效（后期）
        if ("0".equals(userInfo.getDataStatus())) {
            result.put("flag", "false");
    ...
    public Map<String, String> checkAndSavePassword(String mobile, String password) {
        ...
        userInfo.setUpdateTime(DateHelper.getYMDHMSFormatDate(new Date()));
    ...
    public Map<String, String> updateUserAppSecret(Integer userId, String sid) {
        ...
        userInfoTmp.setUpdateTime(DateHelper.getYMDHMSFormatDate(new Date()));
    ...
    public List<UserInfo> listUserInfosByParams(Map<String, Object> params) {
        return userInfoDao.listUserInfosByParams(params);
    }
}
