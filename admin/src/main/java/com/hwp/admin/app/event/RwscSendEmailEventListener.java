 ...
 */
@Component
public class RwscSendEmailEventListener implements ApplicationListener<RwscSendEmailEvent> {
    ...
    @Override
    public void onApplicationEvent(RwscSendEmailEvent event) {
            ...
            public void run() {
                ...
                if (StringHelper.isNotBlank(xmrwxx.getFhrXx())) {
                    ...
                    for (int i = 0; i < selectSpr.size(); i++) {
                        ...
                        mailSenderService.sendEmailMessage(spr.get("id").toString(), "rwsc", spr.get("gsyx").toString(), params);
                    }
                }
                //2、知会人
                ...
                mailSenderService.sendEmailMessage(fzr.get("id").toString(), "rwsc", fzr.get("gsyx").toString(), params);
            }
