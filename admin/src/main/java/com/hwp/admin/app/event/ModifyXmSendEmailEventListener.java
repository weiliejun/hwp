 ...
 */
@Component
public class ModifyXmSendEmailEventListener implements ApplicationListener<ModifyXmSendEmailEvent> {
    ...
    @Override
    public void onApplicationEvent(ModifyXmSendEmailEvent event) {
        final Xmxxgl xmxxgl = (Xmxxgl) event.getXmxxgl();
        final String diff = (String) event.getDiff();
