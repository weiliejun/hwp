layui.define('table', function (exports) {
    ...
    var $ = layui.$
        , table = layui.table
        , layer = layui.layer
        , MOD_NAME = 'transfer', LEFT_TABLE = 'left-table-', RIGHT_TABLE = 'right-table-', LEFT_BTN = 'left-btn-',
        RIGHT_BTN = 'right-btn-', FILTER = 'test'
        , DISABLED = 'layui-btn-disabled', BTN = 'button', BTN_STLY = 'btn', MD5 = 'layui-col-md5',
        MD2 = 'layui-col-md2'
        , transfer = {
