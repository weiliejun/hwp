...
var tabFilter, menu = [], liIndex, curNav, delMenu,
    changeRefreshStr = "true";//window.sessionStorage.getItem("changeRefresh");
layui.define(["element", "jquery"], function (exports) {
    ...
    Tab.prototype.changeRegresh = function (index) {
        ...
        console.log("curmenu:" + JSON.stringify(window.sessionStorage.getItem("curmenu")));
        var title = JSON.parse(window.sessionStorage.getItem("curmenu")).title;
        var href = JSON.parse(window.sessionStorage.getItem("curmenu")).href;
