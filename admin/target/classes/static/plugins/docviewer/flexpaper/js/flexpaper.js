...
window.FlexPaperViewerEmbedding = window.$f = function (id, args) {
    ...
    var _SWFFile, _PDFFile, _IMGFiles, _SVGFiles, _IMGFiles_thumbs = "", _IMGFiles_highres = "", _JSONFile = "",
        _jsDirectory = "", _cssDirectory = "", _localeDirectory = "";
    _WMode = (config.WMode != null || config.wmode != null ? config.wmode || config.WMode : "direct");
...
(function () {
    ...
    FLEXPAPER.animateDenyEffect = function (obj, margin, time, cycles, dir) {
        window.setTimeout(function () {
            ...
            var margRat = 1 + (60 / (cycles * cycles));
            $(obj).stop(true, true);
    ...
    FLEXPAPER.initFrontPagePreview = function initFrontPagePreview(viewerid, args, IMGFiles) {
        ...
        jQuery(img).bind('load', function () {
            ...
            jQuery('.flexpaper_htmldialog').animate({'height': theight + 'px', 'top': '0px'}, {
                duration: anim_height_dur, complete: function () {
            ...
            if (true) {
                jQuery(document).ready(function () {
                    ...
                    jQuery.getScript(conf.jsDirectory + 'FlexPaperViewer.js', function () {
                        ...
                        window[instance]['highlight'] = window[instance].highlight;
