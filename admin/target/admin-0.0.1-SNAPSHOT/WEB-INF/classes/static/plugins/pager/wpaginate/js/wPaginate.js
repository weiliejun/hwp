...
(function ($) {
    ...
    $.fn.wPaginate.defaultSettings = {
        ...
        spread: 3,			// number of links to display on each side (total 11)
    ...
    Paginate.prototype =
        {
            ...
            generateLinks: function () {
                ...
                ////cg 2014-02-18
                this.paginate.append('<span class="_wPaginate_total">总条数: ' + this.settings.total + '</span>');
                if (totalPages < 2) this.paginate.hide();
                ////
            },
